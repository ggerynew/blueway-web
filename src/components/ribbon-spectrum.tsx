...
const T = {
  ...
  it: {
    aria: 'Fascia di selezione del ribbon: da Wax verso Resin',
    appsLabel: 'Applicazioni',
    matsLabel: 'Materiale etichetta',
    apps: [
      ['Etichette per cartoni e spedizioni,', 'logistica, etichette a scaffale'],
      ['Etichette prodotto, alimentare,', 'cosmetica, sanit\u00e0'],
      ['Automotive, elettronica,', 'chimica (GHS), laboratori'],
    ],
    mats: [
      ['Carta naturale (vellum) e', 'carta opaca'],
      ['Carta patinata,', 'film PP / PE'],
      ['PET, poliimmide,', 'vinile, PVC'],
    ],
    zones: ['WAX', 'WAX-RESIN', 'RESIN'],
    axis: 'Prezzo e resistenza',
    low: 'pi\u00f9 basso',
    high: 'pi\u00f9 alto',
  },
  es: {
    aria: 'Banda de selecci\u00f3n de ribbon: de Wax hacia Resin',
    appsLabel: 'Aplicaciones',
    matsLabel: 'Material de la etiqueta',
    apps: [
      ['Etiquetas de cajas y env\u00edos,', 'log\u00edstica, etiquetas de estanter\u00eda'],
      ['Etiquetas de producto, alimentaci\u00f3n,', 'cosm\u00e9tica, sanidad'],
      ['Automoci\u00f3n, electr\u00f3nica,', 'qu\u00edmica (GHS), laboratorios'],
    ],
    mats: [
      ['Papel natural (vellum) y', 'papel mate'],
      ['Papel estucado,', 'film PP / PE'],
      ['PET, poliimida,', 'vinilo, PVC'],
    ],
    zones: ['WAX', 'WAX-RESIN', 'RESIN'],
    axis: 'Precio y durabilidad',
    low: 'menor',
    high: 'mayor',
  },
  ko: {
