...
const manufacturersSource: Sourced<Manufacturer[]> = [
  ...
  },
  {
    ...
    description: {
      ...
      en: 'Robust industrial and desktop label printers from simple printing tasks to RFID labeling, with excellent value for money.', de: 'Robuste Industrie- und Desktop-Etikettendrucker von einfachen Druckaufgaben bis zur RFID-Etikettierung, mit hervorragendem Preis-Leistungs-Verhältnis.', ko: '간단한 인쇄 작업부터 RFID 라벨링까지, 뛰어난 가성비를 갖춘 견고한 산업용 및 데스크톱 라벨 프린터.', zh: '坚固的工业级与桌面型标签打印机，从简单打印任务到 RFID 标签打印，性价比出色。',
    },
  },
  {
    slug: 'tykma-electrox',
  ...
  },
  {
    ...
    description: {
      ...
      en: 'Premium thermal transfer ribbons — wax, wax/resin and resin, from one of the world’s leading manufacturers.', de: 'Premium-Thermotransfer-Farbbänder — Wax, Wax-Resin und Resin, von einem der weltweit führenden Hersteller.', ko: '프리미엄 열전사 리본 — 세계 유수의 제조사가 생산하는 Wax, Wax/Resin 및 Resin 타입.', zh: '高品质热转印碳带——蜡基、混合基与树脂基，出自全球领先制造商之一。',
    },
  },
  {
    slug: 'armor-iimak',
    ...
    description: {
      ...
      en: 'Thermal transfer ribbons for flat-head and near-edge printers — wax, wax/resin and resin families.', de: 'Thermotransfer-Farbbänder für Flat-Head- und Near-Edge-Drucker — Wax-, Wax-Resin- und Resin-Familien.', ko: '플랫 헤드 및 니어 엣지 프린터용 열전사 리본 — Wax, Wax/Resin 및 Resin 제품군.', zh: '适用于平压式与近端式打印机的热转印碳带——蜡基、混合基与树脂基系列。',
    },
  },
  {
...
const categoriesSource: Sourced<Category[]> = [
  {
    slug: 'cimkenyomtatok',
    name: { hu: 'Címkenyomtatók', en: 'Label printers', de: 'Etikettendrucker', ko: '라벨 프린터', zh: '标签打印机' },
    description: {
      hu: 'Asztali és ipari vonalkódnyomtatók különböző méretekben és kijelzőkkel.',
      en: 'Desktop and industrial barcode printers in various sizes and display options.', de: 'Desktop- und Industrie-Barcodedrucker in verschiedenen Größen und Display-Varianten.', ko: '다양한 크기와 디스플레이 옵션을 갖춘 데스크톱 및 산업용 바코드 프린터.', zh: '多种尺寸与显示配置的桌面型及工业级条码打印机。',
    },
  },
  {
    slug: 'cimkezo-gepek',
    name: { hu: 'Címkéző gépek', en: 'Labeling machines', de: 'Etikettiermaschinen', ko: '라벨링 머신', zh: '贴标机' },
    description: {
      hu: 'Nyomtató-felrakó kombinációk és automata pneumatikus címkéző egységek.',
      en: 'Print-and-apply combinations and automatic pneumatic labeling units.', de: 'Print-and-Apply-Kombinationen und automatische pneumatische Etikettiereinheiten.', ko: '프린트 & 어플라이 복합 시스템 및 자동 공압식 라벨링 유닛.', zh: '打印贴标一体系统与自动气动贴标单元。',
    },
  },
  {
    slug: 'cimke-adagolo-gepek',
    name: { hu: 'Címke adagoló gépek', en: 'Label dispensers', de: 'Etikettenspender', ko: '라벨 디스펜서', zh: '标签剥离机' },
    description: {
      hu: 'Automata címkeadagolás és -vágás, különböző kapacitásokkal.',
      en: 'Automatic label dispensing and cutting with various capacities.', de: 'Automatisches Spenden und Schneiden von Etiketten mit verschiedenen Kapazitäten.', ko: '다양한 처리 용량의 자동 라벨 디스펜싱 및 커팅.', zh: '自动标签剥离与切割，多种产能可选。',
    },
  },
  {
    slug: 'lezer-gravirozok',
    name: { hu: 'Lézer gravírozók', en: 'Laser engravers', de: 'Lasergravierer', ko: '레이저 각인기', zh: '激光打标机' },
    description: {
      hu: 'Fém és műanyag jelölésére alkalmas lézerek, kompakt jelölőállomások.',
      en: 'Lasers for marking metal and plastic, compact marking stations.', de: 'Laser zur Markierung von Metall und Kunststoff, kompakte Markierstationen.', ko: '금속 및 플라스틱 마킹용 레이저, 컴팩트 마킹 스테이션.', zh: '用于金属与塑料打标的激光器，以及紧凑型打标工作站。',
    },
  },
  {
    slug: 'szoftverek',
    name: { hu: 'Szoftverek', en: 'Software', de: 'Software', ko: '소프트웨어', zh: '软件' },
    description: {
      hu: 'Címketervező és -nyomtató szoftverek, valamint egyedi fejlesztések.',
      en: 'Label design and printing software, plus custom development.', de: 'Software für Etikettengestaltung und -druck sowie individuelle Entwicklung.', ko: '라벨 디자인 및 인쇄 소프트웨어와 맞춤형 개발.', zh: '标签设计与打印软件，以及定制开发。',
    },
  },
  {
    slug: 'cimkek-es-festekszalagok',
    name: { hu: 'Címkék és festékszalagok', en: 'Labels and ribbons', de: 'Etiketten und Farbbänder', ko: '라벨 및 리본', zh: '标签与碳带' },
    description: {
      hu: 'Papír, hőpapír és műanyag alapanyagok, többféle ragasztóval; festékszalag minden nyomtatótípushoz.',
      en: 'Paper, thermal paper and plastic materials with various adhesives; ribbons for every printer type.', de: 'Papier-, Thermopapier- und Kunststoffmaterialien mit verschiedenen Klebstoffen; Farbbänder für jeden Druckertyp.', ko: '다양한 접착제를 적용한 종이, 감열지 및 플라스틱 소재와 모든 프린터 유형에 맞는 리본.', zh: '多种胶粘剂的纸质、热敏纸与塑料材料；适配各类打印机的碳带。',
    },
  },
  {
    slug: 'ragaszto-adagolok',
    name: { hu: 'Ragasztó adagolók', en: 'Tape dispensers', de: 'Klebebandspender', ko: '테이프 디스펜서', zh: '胶带切割机' },
    description: {
      hu: 'Szalagadagoló berendezések ipari felhasználásra.',
      en: 'Tape dispensing equipment for industrial use.', de: 'Klebeband-Spendegeräte für den Industrieeinsatz.', ko: '산업용 테이프 디스펜싱 장비.', zh: '工业用胶带切割设备。',
    },
  },
];
...
const productsSource: Sourced<Product[]> = [
  {
    ...
    short: {
      ...
      en: 'Narrow industrial model with a 2" printhead for high-volume printing.', de: 'Schmales Industriemodell mit 2"-Druckkopf für hohe Druckvolumen.', ko: '대량 인쇄를 위한 2" 프린트 헤드를 갖춘 폭이 좁은 산업용 모델.', zh: '配备 2" 打印头的窄幅工业机型，适合大批量打印。',
    },
    description: {
      ...
      en: 'The SQUIX 2 specialises in narrow labels within the SQUIX family: 300 or 600 dpi resolution, up to 250 mm/s print speed and 56.9 mm print width. Industrial reliability for small label sizes, with a left-aligned media guide, a robust aluminium mechanism and the full SQUIX range of accessories.', de: 'Der SQUIX 2 ist der Spezialist für schmale Etiketten innerhalb der SQUIX-Familie: 300 oder 600 dpi Auflösung, bis zu 250 mm/s Druckgeschwindigkeit und 56,9 mm Druckbreite. Industrielle Zuverlässigkeit für kleine Etikettenformate, mit linksbündiger Materialführung, robuster Aluminiummechanik und dem vollen SQUIX-Zubehörprogramm.', ko: 'SQUIX 2는 SQUIX 제품군 중 좁은 라벨에 특화된 모델입니다. 300 또는 600 dpi 해상도, 최대 250 mm/s 인쇄 속도, 56.9 mm 인쇄 폭을 제공합니다. 좌측 정렬 미디어 가이드, 견고한 알루미늄 메커니즘, SQUIX 전체 액세서리 라인업과 함께 소형 라벨에 산업용 신뢰성을 제공합니다.', zh: 'SQUIX 2 是 SQUIX 系列中专为窄幅标签打造的机型：300 或 600 dpi 分辨率，打印速度最高 250 mm/s，打印宽度 56.9 mm。为小尺寸标签提供工业级可靠性，配备左对齐介质导向、坚固的铝制机构以及完整的 SQUIX 配件系列。',
    },
    features: [
      { hu: '300 / 600 dpi felbontás', en: '300 / 600 dpi resolution', de: '300 / 600 dpi Auflösung', ko: '300 / 600 dpi 해상도', zh: '300 / 600 dpi 分辨率' },
      { hu: 'Nyomtatási sebesség akár 250 mm/s', en: 'Print speed up to 250 mm/s', de: 'Druckgeschwindigkeit bis 250 mm/s', ko: '최대 250 mm/s 인쇄 속도', zh: '打印速度最高 250 mm/s' },
      { hu: 'Nyomtatási szélesség 56,9 mm (2")', en: 'Print width 56.9 mm (2")', de: 'Druckbreite 56,9 mm (2")', ko: '인쇄 폭 56.9 mm (2")', zh: '打印宽度 56.9 mm（2"）' },
      { hu: 'Keskeny, kis címkékhez', en: 'For narrow, small labels', de: 'Für schmale, kleine Etiketten', ko: '폭이 좁은 소형 라벨용', zh: '适用于窄小标签' },
      { hu: 'SQUIX elektronika és tartozékok', en: 'SQUIX electronics and accessories', de: 'SQUIX-Elektronik und -Zubehör', ko: 'SQUIX 전자 플랫폼 및 액세서리', zh: 'SQUIX 电子平台与配件' },
    ],
  ...
  },
  {
    ...
    short: {
      ...
      en: 'Industrial label printer with a 4" head and robust aluminium chassis.', de: 'Industrie-Etikettendrucker mit 4"-Kopf und robustem Aluminiumchassis.', ko: '4" 헤드와 견고한 알루미늄 섀시를 갖춘 산업용 라벨 프린터.', zh: '配备 4" 打印头与坚固铝制机身的工业标签打印机。',
    },
    description: {
  ...
  },
  {
    ...
    short: {
      ...
      en: 'Industrial printer specifically for very small labels and slim continuous materials.', de: 'Industriedrucker speziell für sehr kleine Etiketten und schmale Endlosmaterialien.', ko: '초소형 라벨과 폭이 좁은 연속 소재 전용 산업용 프린터.', zh: '专为极小标签与细窄连续材料设计的工业打印机。',
    },
    description: {
      ...
      en: 'The SQUIX 4 M is built for precise printing of very small labels and slim continuous materials (e.g. pressed tubes), with a centered media guide — so no adjustment is needed when changing materials. 300 or 600 dpi resolution, up to 300 mm/s, and SQUIX industrial reliability with the full range of accessories.', de: 'Der SQUIX 4 M ist für den präzisen Druck sehr kleiner Etiketten und schmaler Endlosmaterialien (z. B. gepresster Schläuche) gebaut, mit zentrierter Materialführung — beim Materialwechsel ist daher keine Justierung nötig. 300 oder 600 dpi Auflösung, bis zu 300 mm/s und die industrielle SQUIX-Zuverlässigkeit mit dem vollen Zubehörprogramm.', ko: 'SQUIX 4 M은 초소형 라벨과 폭이 좁은 연속 소재(예: 압착 튜브)의 정밀 인쇄를 위해 제작되었으며, 중앙 정렬 미디어 가이드를 채택하여 소재 교체 시 별도의 조정이 필요 없습니다. 300 또는 600 dpi 해상도, 최대 300 mm/s 속도, 그리고 SQUIX의 산업용 신뢰성과 전체 액세서리 라인업을 제공합니다.', zh: 'SQUIX 4 M 专为精确打印极小标签与细窄连续材料（如压制套管）而打造，采用居中介质导向——更换材料时无需调整。300 或 600 dpi 分辨率，最高 300 mm/s，具备 SQUIX 工业级可靠性并支持全系列配件。',
    },
    features: [
      { hu: 'Apró címkékhez és keskeny, végtelenített anyagokhoz', en: 'For small labels and slim continuous materials', de: 'Für kleine Etiketten und schmale Endlosmaterialien', ko: '소형 라벨 및 폭이 좁은 연속 소재용', zh: '适用于小标签与细窄连续材料' },
      { hu: 'Középre igazított anyagvezetés', en: 'Centered media guide', de: 'Zentrierte Materialführung', ko: '중앙 정렬 미디어 가이드', zh: '居中介质导向' },
      { hu: '300 / 600 dpi felbontás, akár 300 mm/s', en: '300 / 600 dpi resolution, up to 300 mm/s', de: '300 / 600 dpi Auflösung, bis zu 300 mm/s', ko: '300 / 600 dpi 해상도, 최대 300 mm/s', zh: '300 / 600 dpi 分辨率，最高 300 mm/s' },
      { hu: 'SQUIX elektronika és tartozékok', en: 'SQUIX electronics and accessories', de: 'SQUIX-Elektronik und -Zubehör', ko: 'SQUIX 전자 플랫폼 및 액세서리', zh: 'SQUIX 电子平台与配件' },
    ],
  },
  {
    ...
    short: {
      ...
      en: 'Industrial printer for textile materials — wash-care and sewn-in labels.', de: 'Industriedrucker für Textilmaterialien — Waschpflege- und eingenähte Etiketten.', ko: '텍스타일 소재용 산업용 프린터 — 세탁 라벨 및 봉제 라벨.', zh: '面向纺织材料的工业打印机——洗涤标与缝入式标签。',
    },
    description: {
      ...
      en: 'The SQUIX 4 MT is optimised for printing textile ribbons and wash-care labels, with a centered media guide. When textiles require high heat, the ribbon may stick to the tape after printing — a built-in draw roller reliably separates it from the material. Media handling tailored to the textile industry, with SQUIX platform reliability.', de: 'Der SQUIX 4 MT ist für den Druck von Textilbändern und Waschpflege-Etiketten optimiert, mit zentrierter Materialführung. Wenn Textilien hohe Temperaturen erfordern, kann das Farbband nach dem Druck am Band haften bleiben — eine integrierte Zugwalze trennt es zuverlässig vom Material. Materialhandling, zugeschnitten auf die Textilindustrie, mit der Zuverlässigkeit der SQUIX-Plattform.', ko: 'SQUIX 4 MT는 텍스타일 리본과 세탁 라벨 인쇄에 최적화되어 있으며 중앙 정렬 미디어 가이드를 갖추었습니다. 텍스타일에 높은 열이 필요한 경우 인쇄 후 리본이 테이프에 달라붙을 수 있는데, 내장 드로우 롤러가 이를 소재에서 확실하게 분리합니다. 텍스타일 산업에 맞춘 미디어 핸들링과 SQUIX 플랫폼의 신뢰성을 제공합니다.', zh: 'SQUIX 4 MT 针对纺织带与洗涤标打印进行了优化，采用居中介质导向。当纺织材料需要高温打印时，碳带可能在打印后粘附在织带上——内置牵引辊可将其与材料可靠分离。介质处理专为纺织行业量身定制，并具备 SQUIX 平台的可靠性。',
    },
    features: [
      { hu: 'Textilszalag és mosáscímke nyomtatása', en: 'Printing textile ribbons & wash-care labels', de: 'Druck von Textilbändern & Waschpflege-Etiketten', ko: '텍스타일 리본 및 세탁 라벨 인쇄', zh: '打印纺织带与洗涤标' },
      { hu: 'Húzógörgő a festékszalag leválasztásához', en: 'Draw roller to separate the ribbon', de: 'Zugwalze zur Trennung des Farbbands', ko: '리본 분리를 위한 드로우 롤러', zh: '牵引辊分离碳带' },
      { hu: 'Középre igazított anyagvezetés', en: 'Centered media guide', de: 'Zentrierte Materialführung', ko: '중앙 정렬 미디어 가이드', zh: '居中介质导向' },
      { hu: 'SQUIX platform megbízhatósága', en: 'SQUIX platform reliability', de: 'Zuverlässigkeit der SQUIX-Plattform', ko: 'SQUIX 플랫폼의 신뢰성', zh: 'SQUIX 平台可靠性' },
    ],
  },
  {
    slug: 'cab-squix-6',
    ...
    short: {
      ...
      en: 'Industrial label printer with a 6" head for wide labels and high volumes.', de: 'Industrie-Etikettendrucker mit 6"-Kopf für breite Etiketten und hohe Volumen.', ko: '넓은 라벨과 대량 인쇄를 위한 6" 헤드 탑재 산업용 라벨 프린터.', zh: '配备 6" 打印头的工业标签打印机，适用于宽幅标签与大批量打印。',
    },
    description: {
  ...
  },
  {
    ...
    short: {
      ...
      en: 'Desktop barcode printer with an attractive design — suitable for front-office use.', de: 'Desktop-Barcodedrucker in attraktivem Design — auch für den Front-Office-Einsatz geeignet.', ko: '세련된 디자인의 데스크톱 바코드 프린터 — 프런트 오피스 사용에도 적합합니다.', zh: '外观时尚的桌面型条码打印机——适合前台办公环境使用。',
    },
    description: {
  ...
  },
  {
    ...
    short: {
      ...
      en: 'Desktop barcode printer that also takes large label rolls.', de: 'Desktop-Barcodedrucker, der auch große Etikettenrollen aufnimmt.', ko: '대형 라벨 롤도 장착 가능한 데스크톱 바코드 프린터.', zh: '可容纳大直径标签卷的桌面型条码打印机。',
    },
    description: {
  ...
  },
  {
    ...
    short: {
      ...
      en: 'Simple, easy-to-use barcode printer for smaller jobs.', de: 'Einfacher, leicht bedienbarer Barcodedrucker für kleinere Aufgaben.', ko: '소규모 작업을 위한 간편하고 사용하기 쉬운 바코드 프린터.', zh: '操作简便的入门级条码打印机，适合较小规模的打印任务。',
    },
    description: {
  ...
  },
  {
    ...
    short: {
      ...
      en: 'For smaller jobs, with a display and simple memory handling.', de: 'Für kleinere Aufgaben, mit Display und einfacher Speicherverwaltung.', ko: '디스플레이와 간편한 메모리 관리 기능을 갖춘 소규모 작업용 모델.', zh: '适合较小规模任务，配备显示屏与简便的存储管理。',
    },
    description: {
  ...
  },
  {
    ...
    short: {
      ...
      en: 'Desktop model for larger printing jobs, with SQUIX electronics.', de: 'Desktop-Modell für größere Druckaufgaben, mit SQUIX-Elektronik.', ko: 'SQUIX 전자 플랫폼을 갖춘 대규모 인쇄 작업용 데스크톱 모델.', zh: '面向较大打印任务的桌面机型，搭载 SQUIX 电子平台。',
    },
    description: {
  ...
  },
  {
    ...
    short: {
      ...
      en: 'Two-colour printing with a 4" head — for GHS hazard labels.', de: 'Zweifarbiger Druck mit 4"-Kopf — für GHS-Gefahrstoffetiketten.', ko: '4" 헤드를 갖춘 2색 인쇄 — GHS 위험물 라벨용.', zh: '配备 4" 打印头的双色打印——适用于 GHS 危险品标签。',
    },
    description: {
  ...
  },
  {
    ...
    short: {
      ...
      en: 'Two-colour printing with a 6" head — for GHS hazard labels.', de: 'Zweifarbiger Druck mit 6"-Kopf — für GHS-Gefahrstoffetiketten.', ko: '6" 헤드를 갖춘 2색 인쇄 — GHS 위험물 라벨용.', zh: '配备 6" 打印头的双色打印——适用于 GHS 危险品标签。',
    },
    description: {
  ...
  },
  {
    ...
    short: {
      ...
      en: 'Double-sided printing in a single pass — for tags and flexible materials.', de: 'Beidseitiger Druck in einem Durchgang — für Anhänger und flexible Materialien.', ko: '한 번의 패스로 양면 인쇄 — 태그 및 유연한 소재용.', zh: '一次走纸即可双面打印——适用于吊牌与柔性材料。',
    },
    description: {
  ...
  // ——— CAB — Print & apply (címkéző gépek) ———
  {
    ...
    short: {
      ...
      en: 'Print & apply system for production lines — precise real-time label application.', de: 'Print-and-Apply-System für Produktionslinien — präzise Etikettierung in Echtzeit.', ko: '생산 라인용 프린트 & 어플라이 시스템 — 정밀한 실시간 라벨 부착.', zh: '面向生产线的打印贴标系统——精确的实时贴标。',
    },
    description: {
      ...
      en: 'The HERMES Q print & apply system is built on the electronics of the latest cab printer generation: a powerful CPU and precise label application onto cylindrical, oblique or curved surfaces with roll-on, blow-on or tamp-on applicators.', de: 'Das Print-and-Apply-System HERMES Q basiert auf der Elektronik der neuesten cab Druckergeneration: leistungsstarke CPU und präzise Etikettierung auf zylindrischen, schrägen oder gewölbten Oberflächen mit Roll-on-, Blow-on- oder Tamp-on-Applikatoren.', ko: 'HERMES Q 프린트 & 어플라이 시스템은 최신 cab 프린터 세대의 전자 플랫폼을 기반으로 합니다. 강력한 CPU와 함께 롤온, 블로우온 또는 탬프온 어플리케이터로 원통형, 경사면 또는 곡면에 라벨을 정밀하게 부착합니다.', zh: 'HERMES Q 打印贴标系统基于最新一代 cab 打印机的电子平台打造：强劲的 CPU，配合滚贴式、吹贴式或压贴式贴标模块，可将标签精确贴附于圆柱面、斜面或曲面。',
    },
    features: [
      { hu: 'Valós idejű print & apply', en: 'Real-time print & apply', de: 'Print & Apply in Echtzeit', ko: '실시간 프린트 & 어플라이', zh: '实时打印贴标' },
      { hu: 'Roll-on / blow-on / tamp-on applikátorok', en: 'Roll-on / blow-on / tamp-on applicators', de: 'Roll-on- / Blow-on- / Tamp-on-Applikatoren', ko: '롤온 / 블로우온 / 탬프온 어플리케이터', zh: '滚贴式 / 吹贴式 / 压贴式贴标模块' },
      { hu: 'Bal és jobb kivitel', en: 'Left and right versions', de: 'Links- und Rechtsversionen', ko: '좌측 및 우측 버전', zh: '左右两种版本' },
      { hu: 'Gyártósori integráció', en: 'Production-line integration', de: 'Integration in Produktionslinien', ko: '생산 라인 통합', zh: '生产线集成' },
    ],
    orientation: {
      image: '/images/applicators/hermes-q-left-right.webp',
      title: { hu: 'Két orientáció, három nyomtatófej-szélesség', en: 'Two orientations, three printhead widths', de: 'Zwei Ausrichtungen, drei Druckkopfbreiten', ko: '2가지 방향, 3가지 프린트 헤드 폭', zh: '两种方向，三种打印头宽度' },
      text: {
        ...
        en: 'The HERMES Q is available in two versions — right-hand and left-hand orientation — so it can be integrated into a production line from either side. The printer modules are available with 2", 4" and 6" wide printheads.', de: 'Der HERMES Q ist in zwei Versionen erhältlich — rechts- und linksorientiert — und lässt sich so von beiden Seiten in eine Produktionslinie integrieren. Die Druckermodule sind mit 2"-, 4"- und 6"-Druckköpfen verfügbar.', ko: 'HERMES Q는 오른쪽 및 왼쪽 방향의 두 가지 버전으로 제공되어 생산 라인의 어느 쪽에서도 통합할 수 있습니다. 프린터 모듈은 2", 4" 및 6" 폭의 프린트 헤드로 제공됩니다.', zh: 'HERMES Q 提供右向与左向两种版本，可从任意一侧集成到生产线中。打印模块提供 2"、4" 与 6" 宽度的打印头。',
      },
    },
    applicators: [
      {
        ...
        name: { hu: '3014/3016 Karos felrakó', en: '3014/3016 Arm applicator', de: '3014/3016 Schwenkarm-Applikator', ko: '3014/3016 암 어플리케이터', zh: '3014/3016 摆臂式贴标模块' },
        description: {
          hu: 'Nagyobb címkékhez, termék elejének, oldalának vagy hátának címkézése.',
          en: 'For larger labels — labeling the front, side or back of the product.', de: 'Für größere Etiketten — Etikettierung vorn, seitlich oder hinten am Produkt.', ko: '대형 라벨용 — 제품의 전면, 측면 또는 후면 라벨링.', zh: '适用于较大标签——在产品正面、侧面或背面贴标。',
        },
        longDescription: {
          ...
          en: 'Applies labels in real time from the top or side onto packages in motion — preferably to the front or back of a package. The pad picks up the label while it is printed, and the pivot arm transfers it to the product at 0–90°.', de: 'Bringt Etiketten in Echtzeit von oben oder von der Seite auf bewegte Verpackungen auf — bevorzugt auf die Vorder- oder Rückseite eines Pakets. Der Stempel übernimmt das Etikett während des Drucks, und der Schwenkarm überträgt es im Winkel von 0–90° auf das Produkt.', ko: '이동 중인 패키지의 상단 또는 측면에서 실시간으로 라벨을 부착하며, 주로 패키지의 전면이나 후면에 부착합니다. 패드가 인쇄되는 라벨을 픽업하고, 피벗 암이 0–90° 범위에서 라벨을 제품에 전달합니다.', zh: '从顶部或侧面向运动中的包装实时贴标——优先贴于包装的正面或背面。吸盘在标签打印的同时将其吸取，摆臂以 0–90° 将标签转贴到产品上。',
        },
        params: [
          { label: { hu: 'Címkeszélesség', en: 'Label width', de: 'Etikettenbreite', ko: '라벨 폭', zh: '标签宽度' }, value: { hu: '25–174 mm', en: '25–174 mm', de: '25–174 mm', ko: '25–174 mm', zh: '25–174 mm' } },
          { label: { hu: 'Címkemagasság', en: 'Label height', de: 'Etikettenhöhe', ko: '라벨 높이', zh: '标签高度' }, value: { hu: '8–250 mm', en: '8–250 mm', de: '8–250 mm', ko: '8–250 mm', zh: '8–250 mm' } },
          { label: { hu: 'Termék állapota', en: 'Product state', de: 'Produktzustand', ko: '제품 상태', zh: '产品状态' }, value: { hu: 'mozgásban vagy álló', en: 'in motion or at rest', de: 'in Bewegung oder im Stillstand', ko: '이동 중 또는 정지 상태', zh: '运动或静止' } },
          { label: { hu: 'Felhelyezés iránya', en: 'Application direction', de: 'Etikettierrichtung', ko: '부착 방향', zh: '贴标方向' }, value: { hu: 'felülről, oldalról, elölről, hátulról', en: 'from top, side, front, back', de: 'von oben, seitlich, vorn, hinten', ko: '상단, 측면, 전면, 후면에서', zh: '从顶部、侧面、正面、背面' } },
          { label: { hu: 'Csomagmagasság', en: 'Package height', de: 'Pakethöhe', ko: '패키지 높이', zh: '包装高度' }, value: { hu: 'változó', en: 'variable', de: 'variabel', ko: '가변', zh: '可变' } },
          { label: { hu: 'Karhossz', en: 'Pivot arm length', de: 'Schwenkarmlänge', ko: '피벗 암 길이', zh: '摆臂长度' }, value: { hu: '200–600 mm', en: '200–600 mm', de: '200–600 mm', ko: '200–600 mm', zh: '200–600 mm' } },
          { label: { hu: 'Elfordulási szög', en: 'Pivot angle', de: 'Schwenkwinkel', ko: '피벗 각도', zh: '摆动角度' }, value: { hu: '0–90°', en: '0–90°', de: '0–90°', ko: '0–90°', zh: '0–90°' } },
          { label: { hu: 'Ciklusidő', en: 'Cycle rate', de: 'Taktrate', ko: '사이클 속도', zh: '贴标节拍' }, value: { hu: '~15 címke/perc', en: '~15 labels/min', de: 'ca. 15 Etiketten/min', ko: '약 15매/분', zh: '约 15 张/分钟' } },
          { label: { hu: 'Sűrített levegő', en: 'Compressed air', de: 'Druckluft', ko: '압축 공기', zh: '压缩空气' }, value: { hu: '4,5 bar', en: '4.5 bar', de: '4,5 bar', ko: '4.5 bar', zh: '4.5 bar' } },
          { label: { hu: 'Teljesítményfelvétel', en: 'Power consumption', de: 'Leistungsaufnahme', ko: '소비 전력', zh: '功耗' }, value: { hu: 'max. 15 W', en: 'max. 15 W', de: 'max. 15 W', ko: '최대 15 W', zh: '最大 15 W' } },
          { label: { hu: 'Tömeg', en: 'Weight', de: 'Gewicht', ko: '중량', zh: '重量' }, value: { hu: '9–12 kg', en: '9–12 kg', de: '9–12 kg', ko: '9–12 kg', zh: '9–12 kg' } },
        ],
      },
      {
        slug: 'hq-4014',
        image: '/images/applicators/hq-4014.webp',
        name: { hu: '4014 Stroke applikátor', en: '4014 Stroke applicator', de: '4014 Hub-Applikator', ko: '4014 스트로크 어플리케이터', zh: '4014 行程式贴标模块' },
        description: {
          hu: 'Egyszerű címkézéshez.',
          en: 'For simple labeling.', de: 'Für einfache Etikettierung.', ko: '간단한 라벨링용.', zh: '适用于简单贴标任务。',
        },
        longDescription: {
          ...
          en: 'Applies labels in real time from all sides onto packages. The type of pad defines whether a package has to be at rest or can be in motion. The stroke cylinder length defines the maximum distance between the package and the peel-off plate.', de: 'Bringt Etiketten in Echtzeit von allen Seiten auf Verpackungen auf. Der Stempeltyp bestimmt, ob ein Paket im Stillstand sein muss oder in Bewegung sein darf. Die Länge des Hubzylinders bestimmt den maximalen Abstand zwischen Paket und Spendekante.', ko: '패키지의 모든 면에 실시간으로 라벨을 부착합니다. 패드 유형에 따라 패키지가 정지 상태여야 하는지 이동 중이어도 되는지가 결정됩니다. 스트로크 실린더 길이는 패키지와 필오프 플레이트 사이의 최대 거리를 결정합니다.', zh: '可从各个方向向包装实时贴标。吸盘类型决定包装必须静止还是可以处于运动状态。行程气缸长度决定包装与剥离板之间的最大距离。',
        },
        params: [
          { label: { hu: 'Címkeszélesség', en: 'Label width', de: 'Etikettenbreite', ko: '라벨 폭', zh: '标签宽度' }, value: { hu: '20–174 mm', en: '20–174 mm', de: '20–174 mm', ko: '20–174 mm', zh: '20–174 mm' } },
          { label: { hu: 'Címkemagasság', en: 'Label height', de: 'Etikettenhöhe', ko: '라벨 높이', zh: '标签高度' }, value: { hu: '20–210 mm', en: '20–210 mm', de: '20–210 mm', ko: '20–210 mm', zh: '20–210 mm' } },
          { label: { hu: 'Termék állapota', en: 'Product state', de: 'Produktzustand', ko: '제품 상태', zh: '产品状态' }, value: { hu: 'álló (párnától függően mozgásban)', en: 'at rest (in motion depending on pad)', de: 'im Stillstand (in Bewegung je nach Stempel)', ko: '정지 상태(패드에 따라 이동 중 가능)', zh: '静止（视吸盘类型可运动）' } },
          { label: { hu: 'Felhelyezés iránya', en: 'Application direction', de: 'Etikettierrichtung', ko: '부착 방향', zh: '贴标方向' }, value: { hu: 'felülről, alulról, oldalról', en: 'from top, below, side', de: 'von oben, unten, seitlich', ko: '상단, 하단, 측면에서', zh: '从顶部、底部、侧面' } },
          { label: { hu: 'Csomagmagasság', en: 'Package height', de: 'Pakethöhe', ko: '패키지 높이', zh: '包装高度' }, value: { hu: 'változó', en: 'variable', de: 'variabel', ko: '가변', zh: '可变' } },
          { label: { hu: 'Termék távolsága az egység aljától', en: 'Distance to bottom of unit', de: 'Abstand zur Geräteunterkante', ko: '유닛 하단까지의 거리', zh: '距设备底部距离' }, value: { hu: 'max. 130–530 mm', en: 'up to 130–530 mm', de: 'bis 130–530 mm', ko: '최대 130–530 mm', zh: '最大 130–530 mm' } },
          { label: { hu: 'Ciklusidő', en: 'Cycle rate', de: 'Taktrate', ko: '사이클 속도', zh: '贴标节拍' }, value: { hu: '~25 címke/perc', en: '~25 labels/min', de: 'ca. 25 Etiketten/min', ko: '약 25매/분', zh: '约 25 张/分钟' } },
          { label: { hu: 'Sűrített levegő', en: 'Compressed air', de: 'Druckluft', ko: '압축 공기', zh: '压缩空气' }, value: { hu: '4,5 bar', en: '4.5 bar', de: '4,5 bar', ko: '4.5 bar', zh: '4.5 bar' } },
          { label: { hu: 'Teljesítményfelvétel', en: 'Power consumption', de: 'Leistungsaufnahme', ko: '소비 전력', zh: '功耗' }, value: { hu: 'max. 15 W', en: 'max. 15 W', de: 'max. 15 W', ko: '최대 15 W', zh: '最大 15 W' } },
          { label: { hu: 'Tömeg', en: 'Weight', de: 'Gewicht', ko: '중량', zh: '重量' }, value: { hu: '5–9,5 kg', en: '5–9.5 kg', de: '5–9,5 kg', ko: '5–9.5 kg', zh: '5–9.5 kg' } },
        ],
      },
      {
        slug: 'hq-4114',
        image: '/images/applicators/hq-4114.webp',
        name: { hu: '4114 Stroke applikátor', en: '4114 Stroke applicator', de: '4114 Hub-Applikator', ko: '4114 스트로크 어플리케이터', zh: '4114 行程式贴标模块' },
        description: {
          hu: 'Nagy pontosságú címkézés kis címkékhez (min. 4x4mm).',
          en: 'High-precision labeling for small labels (min. 4x4 mm).', de: 'Hochpräzise Etikettierung für kleine Etiketten (min. 4x4 mm).', ko: '소형 라벨(최소 4x4 mm)을 위한 고정밀 라벨링.', zh: '针对小标签（最小 4x4 mm）的高精度贴标。',
        },
        longDescription: {
          ...
          en: 'Applies very small and midsized labels in real time from all sides. The pad picks up the label while it is printed and a short stroke cylinder brings it into position horizontally. With a form pad it labels cylindrical and curved surfaces too.', de: 'Bringt sehr kleine und mittelgroße Etiketten in Echtzeit von allen Seiten auf. Der Stempel übernimmt das Etikett während des Drucks, ein kurzer Hubzylinder bringt es horizontal in Position. Mit einem Formstempel etikettiert er auch zylindrische und gewölbte Oberflächen.', ko: '초소형 및 중형 라벨을 모든 면에서 실시간으로 부착합니다. 패드가 인쇄되는 라벨을 픽업하고 쇼트 스트로크 실린더가 이를 수평 위치로 이동시킵니다. 폼 패드를 사용하면 원통형 표면과 곡면에도 라벨을 부착할 수 있습니다.', zh: '可从各个方向实时贴附极小及中等尺寸的标签。吸盘在标签打印的同时将其吸取，短行程气缸将其水平送至贴标位置。配合成型吸盘还可为圆柱面与曲面贴标。',
        },
        params: [
          { label: { hu: 'Címkeszélesség', en: 'Label width', de: 'Etikettenbreite', ko: '라벨 폭', zh: '标签宽度' }, value: { hu: '10–174 mm', en: '10–174 mm', de: '10–174 mm', ko: '10–174 mm', zh: '10–174 mm' } },
          { label: { hu: 'Címkemagasság', en: 'Label height', de: 'Etikettenhöhe', ko: '라벨 높이', zh: '标签高度' }, value: { hu: '8–80 mm', en: '8–80 mm', de: '8–80 mm', ko: '8–80 mm', zh: '8–80 mm' } },
          { label: { hu: 'Termék állapota', en: 'Product state', de: 'Produktzustand', ko: '제품 상태', zh: '产品状态' }, value: { hu: 'álló', en: 'at rest', de: 'im Stillstand', ko: '정지 상태', zh: '静止' } },
          { label: { hu: 'Felhelyezés iránya', en: 'Application direction', de: 'Etikettierrichtung', ko: '부착 방향', zh: '贴标方向' }, value: { hu: 'felülről, alulról, oldalról', en: 'from top, below, side', de: 'von oben, unten, seitlich', ko: '상단, 하단, 측면에서', zh: '从顶部、底部、侧面' } },
          { label: { hu: 'Termékmagasság', en: 'Product height', de: 'Produkthöhe', ko: '제품 높이', zh: '产品高度' }, value: { hu: 'változó', en: 'variable', de: 'variabel', ko: '가변', zh: '可变' } },
          { label: { hu: 'Termék távolsága az egység aljától', en: 'Distance to bottom of unit', de: 'Abstand zur Geräteunterkante', ko: '유닛 하단까지의 거리', zh: '距设备底部距离' }, value: { hu: 'max. 135–535 mm', en: 'up to 135–535 mm', de: 'bis 135–535 mm', ko: '최대 135–535 mm', zh: '最大 135–535 mm' } },
          { label: { hu: 'Ciklusidő', en: 'Cycle rate', de: 'Taktrate', ko: '사이클 속도', zh: '贴标节拍' }, value: { hu: '~20 címke/perc', en: '~20 labels/min', de: 'ca. 20 Etiketten/min', ko: '약 20매/분', zh: '约 20 张/分钟' } },
          { label: { hu: 'Sűrített levegő', en: 'Compressed air', de: 'Druckluft', ko: '압축 공기', zh: '压缩空气' }, value: { hu: '4,5 bar', en: '4.5 bar', de: '4,5 bar', ko: '4.5 bar', zh: '4.5 bar' } },
          { label: { hu: 'Teljesítményfelvétel', en: 'Power consumption', de: 'Leistungsaufnahme', ko: '소비 전력', zh: '功耗' }, value: { hu: 'max. 15 W', en: 'max. 15 W', de: 'max. 15 W', ko: '최대 15 W', zh: '最大 15 W' } },
          { label: { hu: 'Tömeg', en: 'Weight', de: 'Gewicht', ko: '중량', zh: '重量' }, value: { hu: '5–9 kg', en: '5–9 kg', de: '5–9 kg', ko: '5–9 kg', zh: '5–9 kg' } },
        ],
        videoId: 'P-9HXQJ-Lds',
      },
      {
        ...
        name: { hu: '4214 Stroke turn applikátor', en: '4214 Stroke turn applicator', de: '4214 Dreh-Hub-Applikator', ko: '4214 스트로크 턴 어플리케이터', zh: '4214 行程回转式贴标模块' },
        description: {
          hu: 'Kis címkék minden oldalról, nehezen beépíthető helyeken is.',
          en: 'Small labels from all sides, also in hard-to-install positions.', de: 'Kleine Etiketten von allen Seiten, auch in schwer zugänglichen Einbaulagen.', ko: '설치가 어려운 위치에서도 모든 면에 소형 라벨을 부착합니다.', zh: '从各个方向贴附小标签，亦适用于难以安装设备的位置。',
        },
        longDescription: {
          ...
          en: 'Applies very small or midsized labels in real time from all sides where the unit is difficult to install. A rotary cylinder pivots the pad by up to 180° horizontally into the application plane, then a stroke cylinder transfers the label to the product.', de: 'Bringt sehr kleine oder mittelgroße Etiketten in Echtzeit von allen Seiten auf, wo der Einbau des Geräts schwierig ist. Ein Drehzylinder schwenkt den Stempel horizontal um bis zu 180° in die Etikettierebene, anschließend überträgt ein Hubzylinder das Etikett auf das Produkt.', ko: '유닛 설치가 어려운 곳에서 초소형 또는 중형 라벨을 모든 면에 실시간으로 부착합니다. 로터리 실린더가 패드를 수평으로 최대 180°까지 회전시켜 부착 평면에 위치시키고, 이어서 스트로크 실린더가 라벨을 제품에 전달합니다.', zh: '在设备难以安装的位置，从各个方向实时贴附极小或中等尺寸的标签。回转气缸将吸盘在水平方向最大旋转 180° 至贴标平面，随后行程气缸将标签转贴到产品上。',
        },
        params: [
          { label: { hu: 'Címkeszélesség', en: 'Label width', de: 'Etikettenbreite', ko: '라벨 폭', zh: '标签宽度' }, value: { hu: '4–80 mm', en: '4–80 mm', de: '4–80 mm', ko: '4–80 mm', zh: '4–80 mm' } },
          { label: { hu: 'Címkemagasság', en: 'Label height', de: 'Etikettenhöhe', ko: '라벨 높이', zh: '标签高度' }, value: { hu: '4–40 mm', en: '4–40 mm', de: '4–40 mm', ko: '4–40 mm', zh: '4–40 mm' } },
          { label: { hu: 'Termék állapota', en: 'Product state', de: 'Produktzustand', ko: '제품 상태', zh: '产品状态' }, value: { hu: 'álló (fújópárnával mozgásban)', en: 'at rest (in motion with blow-on pad)', de: 'im Stillstand (in Bewegung mit Blasstempel)', ko: '정지 상태(블로우온 패드 사용 시 이동 중 가능)', zh: '静止（配吹贴吸盘可运动）' } },
          { label: { hu: 'Felhelyezés iránya', en: 'Application direction', de: 'Etikettierrichtung', ko: '부착 방향', zh: '贴标方向' }, value: { hu: 'felülről, alulról, oldalról', en: 'from top, below, side', de: 'von oben, unten, seitlich', ko: '상단, 하단, 측면에서', zh: '从顶部、底部、侧面' } },
          { label: { hu: 'Vízszintes elfordulás', en: 'Horizontal rotation', de: 'Horizontale Drehung', ko: '수평 회전', zh: '水平旋转' }, value: { hu: '90°, 0° (180° max. 15 mm magas címkénél)', en: '90°, 0° (180° for labels up to 15 mm high)', de: '90°, 0° (180° bei Etiketten bis 15 mm Höhe)', ko: '90°, 0°(높이 15 mm 이하 라벨은 180°)', zh: '90°、0°（标签高度不超过 15 mm 时可 180°）' } },
          { label: { hu: 'Termék távolsága az egység aljától', en: 'Distance to bottom of unit', de: 'Abstand zur Geräteunterkante', ko: '유닛 하단까지의 거리', zh: '距设备底部距离' }, value: { hu: 'max. 135–335 mm', en: 'up to 135–335 mm', de: 'bis 135–335 mm', ko: '최대 135–335 mm', zh: '最大 135–335 mm' } },
          { label: { hu: 'Ciklusidő', en: 'Cycle rate', de: 'Taktrate', ko: '사이클 속도', zh: '贴标节拍' }, value: { hu: '~20 címke/perc', en: '~20 labels/min', de: 'ca. 20 Etiketten/min', ko: '약 20매/분', zh: '约 20 张/分钟' } },
          { label: { hu: 'Sűrített levegő', en: 'Compressed air', de: 'Druckluft', ko: '압축 공기', zh: '压缩空气' }, value: { hu: '4,5 bar', en: '4.5 bar', de: '4,5 bar', ko: '4.5 bar', zh: '4.5 bar' } },
          { label: { hu: 'Teljesítményfelvétel', en: 'Power consumption', de: 'Leistungsaufnahme', ko: '소비 전력', zh: '功耗' }, value: { hu: 'max. 15 W', en: 'max. 15 W', de: 'max. 15 W', ko: '최대 15 W', zh: '最大 15 W' } },
          { label: { hu: 'Tömeg', en: 'Weight', de: 'Gewicht', ko: '중량', zh: '重量' }, value: { hu: '5–7,5 kg', en: '5–7.5 kg', de: '5–7,5 kg', ko: '5–7.5 kg', zh: '5–7.5 kg' } },
        ],
        videoId: '0QethJtANc0',
      },
      {
        ...
        name: { hu: '4414 Stroke applikátor', en: '4414 Stroke applicator', de: '4414 Hub-Applikator', ko: '4414 스트로크 어플리케이터', zh: '4414 行程式贴标模块' },
        description: {
          hu: 'Kis és közepes címkék minden oldalról, x-y irányban állítható pozícióval.',
          en: 'Small and midsized labels from all sides, with an x-y adjustable position.', de: 'Kleine und mittelgroße Etiketten von allen Seiten, mit in x- und y-Richtung justierbarer Position.', ko: '소형 및 중형 라벨을 모든 면에 부착, x-y 방향 위치 조정 가능.', zh: '从各个方向贴附小型及中型标签，贴标位置可在 x-y 方向调节。',
        },
        longDescription: {
          ...
          en: 'Applies very small and midsized labels in real time from all sides. The application position is finely adjustable in both x and y directions. Two short stroke cylinders bring the pad exactly into position, then a stroke cylinder places the label on the product.', de: 'Bringt sehr kleine und mittelgroße Etiketten in Echtzeit von allen Seiten auf. Die Etikettierposition ist in x- und y-Richtung fein justierbar. Zwei kurze Hubzylinder bringen den Stempel exakt in Position, anschließend setzt ein Hubzylinder das Etikett auf das Produkt.', ko: '초소형 및 중형 라벨을 모든 면에서 실시간으로 부착합니다. 부착 위치는 x와 y 방향 모두 미세 조정이 가능합니다. 2개의 쇼트 스트로크 실린더가 패드를 정확한 위치로 이동시킨 후, 스트로크 실린더가 라벨을 제품에 부착합니다.', zh: '可从各个方向实时贴附极小及中等尺寸的标签。贴标位置可在 x 和 y 两个方向精细调节。两个短行程气缸将吸盘精确定位，随后行程气缸将标签贴到产品上。',
        },
        params: [
          { label: { hu: 'Címkeszélesség', en: 'Label width', de: 'Etikettenbreite', ko: '라벨 폭', zh: '标签宽度' }, value: { hu: '4–114 mm', en: '4–114 mm', de: '4–114 mm', ko: '4–114 mm', zh: '4–114 mm' } },
          { label: { hu: 'Címkemagasság', en: 'Label height', de: 'Etikettenhöhe', ko: '라벨 높이', zh: '标签高度' }, value: { hu: '4–80 mm', en: '4–80 mm', de: '4–80 mm', ko: '4–80 mm', zh: '4–80 mm' } },
          { label: { hu: 'Termék állapota', en: 'Product state', de: 'Produktzustand', ko: '제품 상태', zh: '产品状态' }, value: { hu: 'álló', en: 'at rest', de: 'im Stillstand', ko: '정지 상태', zh: '静止' } },
          { label: { hu: 'Felhelyezés iránya', en: 'Application direction', de: 'Etikettierrichtung', ko: '부착 방향', zh: '贴标方向' }, value: { hu: 'felülről, alulról, oldalról', en: 'from top, below, side', de: 'von oben, unten, seitlich', ko: '상단, 하단, 측면에서', zh: '从顶部、底部、侧面' } },
          { label: { hu: 'Termékmagasság', en: 'Product height', de: 'Produkthöhe', ko: '제품 높이', zh: '产品高度' }, value: { hu: 'változó', en: 'variable', de: 'variabel', ko: '가변', zh: '可变' } },
          { label: { hu: 'Pozícióállítás (x / y)', en: 'Position adjustment (x / y)', de: 'Positionsjustierung (x / y)', ko: '위치 조정(x / y)', zh: '位置调节（x / y）' }, value: { hu: 'x 3–7 mm, y 11–15 mm', en: 'x 3–7 mm, y 11–15 mm', de: 'x 3–7 mm, y 11–15 mm', ko: 'x 3–7 mm, y 11–15 mm', zh: 'x 3–7 mm，y 11–15 mm' } },
          { label: { hu: 'Termék távolsága az egység aljától', en: 'Distance to bottom of unit', de: 'Abstand zur Geräteunterkante', ko: '유닛 하단까지의 거리', zh: '距设备底部距离' }, value: { hu: 'max. 135–335 mm', en: 'up to 135–335 mm', de: 'bis 135–335 mm', ko: '최대 135–335 mm', zh: '最大 135–335 mm' } },
          { label: { hu: 'Ciklusidő', en: 'Cycle rate', de: 'Taktrate', ko: '사이클 속도', zh: '贴标节拍' }, value: { hu: '~25 címke/perc', en: '~25 labels/min', de: 'ca. 25 Etiketten/min', ko: '약 25매/분', zh: '约 25 张/分钟' } },
          { label: { hu: 'Sűrített levegő', en: 'Compressed air', de: 'Druckluft', ko: '압축 공기', zh: '压缩空气' }, value: { hu: '4,5 bar', en: '4.5 bar', de: '4,5 bar', ko: '4.5 bar', zh: '4.5 bar' } },
          { label: { hu: 'Teljesítményfelvétel', en: 'Power consumption', de: 'Leistungsaufnahme', ko: '소비 전력', zh: '功耗' }, value: { hu: 'max. 15 W', en: 'max. 15 W', de: 'max. 15 W', ko: '최대 15 W', zh: '最大 15 W' } },
          { label: { hu: 'Tömeg', en: 'Weight', de: 'Gewicht', ko: '중량', zh: '重量' }, value: { hu: '5–6 kg', en: '5–6 kg', de: '5–6 kg', ko: '5–6 kg', zh: '5–6 kg' } },
        ],
      },
      {
        slug: 'hq-4714',
        image: '/images/applicators/hq-4714.webp',
        name: { hu: '4714 Zászló címkéző', en: '4714 Flag applicator', de: '4714 Fahnen-Applikator', ko: '4714 플래그 어플리케이터', zh: '4714 旗形贴标模块' },
        description: {
          hu: 'Kábelek címkézése nagy pontossággal.',
          en: 'High-precision labeling of cables.', de: 'Hochpräzise Etikettierung von Kabeln.', ko: '케이블의 고정밀 라벨링.', zh: '线缆的高精度贴标。',
        },
        longDescription: {
          ...
          en: 'Applies labels precisely in real time onto round materials such as cables, hoses or pipes. The pad picks up the label while it is printed, then a cam-controlled cylinder guides it around the material: both label ends stick together and the label is tamped as a flag.', de: 'Bringt Etiketten in Echtzeit präzise auf runde Materialien wie Kabel, Schläuche oder Rohre auf. Der Stempel übernimmt das Etikett während des Drucks, dann führt es ein kurvengesteuerter Zylinder um das Material: Beide Etikettenenden kleben zusammen, und das Etikett wird als Fahne angedrückt.', ko: '케이블, 호스, 파이프 등 원형 소재에 실시간으로 라벨을 정밀하게 부착합니다. 패드가 인쇄되는 라벨을 픽업한 후 캠 제어 실린더가 라벨을 소재 둘레로 감싸도록 안내합니다. 라벨의 양 끝이 서로 접착되어 라벨이 플래그 형태로 부착됩니다.', zh: '可将标签实时精确贴附于线缆、软管或管材等圆形材料上。吸盘在标签打印的同时将其吸取，随后由凸轮控制的气缸引导标签环绕材料：标签两端相互粘合，以旗形方式贴附。',
        },
        params: [
          { label: { hu: 'Címkeszélesség', en: 'Label width', de: 'Etikettenbreite', ko: '라벨 폭', zh: '标签宽度' }, value: { hu: '50–100 mm', en: '50–100 mm', de: '50–100 mm', ko: '50–100 mm', zh: '50–100 mm' } },
          { label: { hu: 'Címkemagasság', en: 'Label height', de: 'Etikettenhöhe', ko: '라벨 높이', zh: '标签高度' }, value: { hu: '10–50 mm', en: '10–50 mm', de: '10–50 mm', ko: '10–50 mm', zh: '10–50 mm' } },
          { label: { hu: 'Átmérő (kábel/cső)', en: 'Diameter (cable/pipe)', de: 'Durchmesser (Kabel/Rohr)', ko: '직경(케이블/파이프)', zh: '直径（线缆/管材）' }, value: { hu: '3–16 mm', en: '3–16 mm', de: '3–16 mm', ko: '3–16 mm', zh: '3–16 mm' } },
          { label: { hu: 'Termék állapota', en: 'Product state', de: 'Produktzustand', ko: '제품 상태', zh: '产品状态' }, value: { hu: 'álló', en: 'at rest', de: 'im Stillstand', ko: '정지 상태', zh: '静止' } },
          { label: { hu: 'Felhelyezés iránya', en: 'Application direction', de: 'Etikettierrichtung', ko: '부착 방향', zh: '贴标方向' }, value: { hu: 'felülről, alulról, oldalról; függőlegesen 0–180° forgatva', en: 'from top, below, side; rotated vertically 0–180°', de: 'von oben, unten, seitlich; vertikal um 0–180° gedreht', ko: '상단, 하단, 측면에서; 수직 방향 0–180° 회전', zh: '从顶部、底部、侧面；可垂直旋转 0–180°' } },
          { label: { hu: 'Termék távolsága az egység aljától', en: 'Distance to bottom of unit', de: 'Abstand zur Geräteunterkante', ko: '유닛 하단까지의 거리', zh: '距设备底部距离' }, value: { hu: 'min. 70 mm, max. 260 mm', en: 'min. 70 mm, max. 260 mm', de: 'min. 70 mm, max. 260 mm', ko: '최소 70 mm, 최대 260 mm', zh: '最小 70 mm，最大 260 mm' } },
          { label: { hu: 'Ciklusidő', en: 'Cycle rate', de: 'Taktrate', ko: '사이클 속도', zh: '贴标节拍' }, value: { hu: '~15 címke/perc', en: '~15 labels/min', de: 'ca. 15 Etiketten/min', ko: '약 15매/분', zh: '约 15 张/分钟' } },
          { label: { hu: 'Sűrített levegő', en: 'Compressed air', de: 'Druckluft', ko: '압축 공기', zh: '压缩空气' }, value: { hu: '4,5 bar', en: '4.5 bar', de: '4,5 bar', ko: '4.5 bar', zh: '4.5 bar' } },
          { label: { hu: 'Teljesítményfelvétel', en: 'Power consumption', de: 'Leistungsaufnahme', ko: '소비 전력', zh: '功耗' }, value: { hu: 'max. 15 W', en: 'max. 15 W', de: 'max. 15 W', ko: '최대 15 W', zh: '最大 15 W' } },
          { label: { hu: 'Tömeg', en: 'Weight', de: 'Gewicht', ko: '중량', zh: '重量' }, value: { hu: '8 kg', en: '8 kg', de: '8 kg', ko: '8 kg', zh: '8 kg' } },
        ],
        videoId: 'SV0G6Z2yb-4',
      },
      {
        ...
        name: { hu: '6014 Ráfújó címkéző', en: '6014 Blow-on applicator', de: '6014 Blasapplikator', ko: '6014 블로우온 어플리케이터', zh: '6014 吹贴式贴标模块' },
        description: {
          hu: 'Törékeny vagy egyenetlen felületek címkézése, nagy sebességgel.',
          en: 'Labeling fragile or uneven surfaces at high speed.', de: 'Etikettierung empfindlicher oder unebener Oberflächen mit hoher Geschwindigkeit.', ko: '깨지기 쉽거나 고르지 않은 표면의 고속 라벨링.', zh: '高速贴标易碎或不平整的表面。',
        },
        longDescription: {
          ...
          en: 'Applies labels contactlessly onto packages in motion or at rest. Each label is held by a fan and blown off through aligned nozzles by a powerful blast of air. Depending on the label size, a distance of up to 200 mm can be bridged.', de: 'Bringt Etiketten berührungslos auf bewegte oder ruhende Verpackungen auf. Jedes Etikett wird von einem Lüfter gehalten und durch einen kräftigen Luftstoß über ausgerichtete Düsen abgeblasen. Je nach Etikettengröße lässt sich ein Abstand von bis zu 200 mm überbrücken.', ko: '이동 중이거나 정지 상태인 패키지에 비접촉 방식으로 라벨을 부착합니다. 각 라벨은 팬으로 고정되며 정렬된 노즐을 통한 강력한 공기 분사로 부착됩니다. 라벨 크기에 따라 최대 200 mm의 거리까지 커버할 수 있습니다.', zh: '以非接触方式向运动或静止的包装贴标。每张标签由风扇吸持，再通过对准的喷嘴以强力气流吹出。根据标签尺寸，可跨越最大 200 mm 的距离。',
        },
        params: [
          { label: { hu: 'Címkeszélesség', en: 'Label width', de: 'Etikettenbreite', ko: '라벨 폭', zh: '标签宽度' }, value: { hu: '50–114 mm', en: '50–114 mm', de: '50–114 mm', ko: '50–114 mm', zh: '50–114 mm' } },
          { label: { hu: 'Címkemagasság', en: 'Label height', de: 'Etikettenhöhe', ko: '라벨 높이', zh: '标签高度' }, value: { hu: '50–125 mm', en: '50–125 mm', de: '50–125 mm', ko: '50–125 mm', zh: '50–125 mm' } },
          { label: { hu: 'Termék állapota', en: 'Product state', de: 'Produktzustand', ko: '제품 상태', zh: '产品状态' }, value: { hu: 'álló vagy mozgásban', en: 'at rest or in motion', de: 'im Stillstand oder in Bewegung', ko: '정지 또는 이동 중', zh: '静止或运动' } },
          { label: { hu: 'Felhelyezés iránya', en: 'Application direction', de: 'Etikettierrichtung', ko: '부착 방향', zh: '贴标方向' }, value: { hu: 'felülről, alulról, oldalról', en: 'from top, below, side', de: 'von oben, unten, seitlich', ko: '상단, 하단, 측면에서', zh: '从顶部、底部、侧面' } },
          { label: { hu: 'Csomagmagasság', en: 'Package height', de: 'Pakethöhe', ko: '패키지 높이', zh: '包装高度' }, value: { hu: 'változó', en: 'variable', de: 'variabel', ko: '가변', zh: '可变' } },
          { label: { hu: 'Csomag távolsága a lehúzóéltől', en: 'Distance to peel-off plate', de: 'Abstand zur Spendekante', ko: '필오프 플레이트까지의 거리', zh: '距剥离板距离' }, value: { hu: 'max. 200 mm', en: 'up to 200 mm', de: 'bis 200 mm', ko: '최대 200 mm', zh: '最大 200 mm' } },
          { label: { hu: 'Ciklusidő', en: 'Cycle rate', de: 'Taktrate', ko: '사이클 속도', zh: '贴标节拍' }, value: { hu: 'max. 100 címke/perc', en: 'up to 100 labels/min', de: 'bis 100 Etiketten/min', ko: '최대 100매/분', zh: '最高 100 张/分钟' } },
          { label: { hu: 'Sűrített levegő', en: 'Compressed air', de: 'Druckluft', ko: '압축 공기', zh: '压缩空气' }, value: { hu: '4,5 bar', en: '4.5 bar', de: '4,5 bar', ko: '4.5 bar', zh: '4.5 bar' } },
          { label: { hu: 'Teljesítményfelvétel', en: 'Power consumption', de: 'Leistungsaufnahme', ko: '소비 전력', zh: '功耗' }, value: { hu: 'max. 90 W', en: 'max. 90 W', de: 'max. 90 W', ko: '최대 90 W', zh: '最大 90 W' } },
          { label: { hu: 'Tömeg', en: 'Weight', de: 'Gewicht', ko: '중량', zh: '重量' }, value: { hu: '4 kg', en: '4 kg', de: '4 kg', ko: '4 kg', zh: '4 kg' } },
        ],
      },
      {
        slug: 'hq-5314',
        image: '/images/applicators/hq-5314.webp',
        name: { hu: '5314 Vákuumszalagos applikátor', en: '5314 Vacuum-belt applicator', de: '5314 Vakuumband-Applikator', ko: '5314 진공 벨트 어플리케이터', zh: '5314 真空带式贴标模块' },
        description: {
          hu: 'Címkézés nagy sebességgel, mozgásban lévő termékeknél.',
          en: 'High-speed labeling of products in motion.', de: 'Hochgeschwindigkeits-Etikettierung bewegter Produkte.', ko: '이동 중인 제품의 고속 라벨링.', zh: '对运动中的产品进行高速贴标。',
        },
        longDescription: {
          ...
          en: 'Applies labels in real time from all sides onto plane surfaces of packages in motion. A vacuum belt conveys the printed label to the point of transfer, and application is triggered by an external signal.', de: 'Bringt Etiketten in Echtzeit von allen Seiten auf ebene Oberflächen bewegter Verpackungen auf. Ein Vakuumband befördert das gedruckte Etikett zum Übergabepunkt; die Etikettierung wird durch ein externes Signal ausgelöst.', ko: '이동 중인 패키지의 평면에 모든 면에서 실시간으로 라벨을 부착합니다. 진공 벨트가 인쇄된 라벨을 전달 지점까지 이송하며, 부착은 외부 신호로 트리거됩니다.', zh: '可从各个方向向运动中包装的平面实时贴标。真空传送带将打印好的标签输送至转贴点，贴标由外部信号触发。',
        },
        params: [
          { label: { hu: 'Címkeszélesség', en: 'Label width', de: 'Etikettenbreite', ko: '라벨 폭', zh: '标签宽度' }, value: { hu: '20–174 mm', en: '20–174 mm', de: '20–174 mm', ko: '20–174 mm', zh: '20–174 mm' } },
          { label: { hu: 'Címkemagasság', en: 'Label height', de: 'Etikettenhöhe', ko: '라벨 높이', zh: '标签高度' }, value: { hu: '60–456 mm', en: '60–456 mm', de: '60–456 mm', ko: '60–456 mm', zh: '60–456 mm' } },
          { label: { hu: 'Termék állapota', en: 'Product state', de: 'Produktzustand', ko: '제품 상태', zh: '产品状态' }, value: { hu: 'mozgásban', en: 'in motion', de: 'in Bewegung', ko: '이동 중', zh: '运动' } },
          { label: { hu: 'Felhelyezés iránya', en: 'Application direction', de: 'Etikettierrichtung', ko: '부착 방향', zh: '贴标方向' }, value: { hu: 'felülről, alulról, oldalról (sík felületre)', en: 'from top, below, side (plane surfaces)', de: 'von oben, unten, seitlich (ebene Flächen)', ko: '상단, 하단, 측면에서(평면)', zh: '从顶部、底部、侧面（平面）' } },
          { label: { hu: 'Csomagmagasság', en: 'Package height', de: 'Pakethöhe', ko: '패키지 높이', zh: '包装高度' }, value: { hu: 'egyenletes', en: 'uniform', de: 'einheitlich', ko: '균일', zh: '一致' } },
          { label: { hu: 'Csomagsebesség', en: 'Package speed', de: 'Paketgeschwindigkeit', ko: '패키지 속도', zh: '包装速度' }, value: { hu: 'max. 0,5 m/s', en: 'up to 0.5 m/s', de: 'bis 0,5 m/s', ko: '최대 0.5 m/s', zh: '最高 0.5 m/s' } },
          { label: { hu: 'Vákuumszalag sebessége', en: 'Vacuum-belt speed', de: 'Vakuumbandgeschwindigkeit', ko: '진공 벨트 속도', zh: '真空带速度' }, value: { hu: '100–500 mm/s', en: '100–500 mm/s', de: '100–500 mm/s', ko: '100–500 mm/s', zh: '100–500 mm/s' } },
          { label: { hu: 'Ciklusidő', en: 'Cycle rate', de: 'Taktrate', ko: '사이클 속도', zh: '贴标节拍' }, value: { hu: 'max. 30 címke/perc', en: 'up to 30 labels/min', de: 'bis 30 Etiketten/min', ko: '최대 30매/분', zh: '最高 30 张/分钟' } },
          { label: { hu: 'Teljesítményfelvétel', en: 'Power consumption', de: 'Leistungsaufnahme', ko: '소비 전력', zh: '功耗' }, value: { hu: 'max. 90 W', en: 'max. 90 W', de: 'max. 90 W', ko: '최대 90 W', zh: '最大 90 W' } },
          { label: { hu: 'Tömeg', en: 'Weight', de: 'Gewicht', ko: '중량', zh: '重量' }, value: { hu: '7–8 kg', en: '7–8 kg', de: '7–8 kg', ko: '7–8 kg', zh: '7–8 kg' } },
        ],
      },
      {
        slug: 'hq-4514',
        image: '/images/applicators/hq-4514.webp',
        name: { hu: '4514 Swing Stroke applikátor', en: '4514 Swing stroke applicator', de: '4514 Schwenk-Hub-Applikator', ko: '4514 스윙 스트로크 어플리케이터', zh: '4514 摆动行程式贴标模块' },
        description: {
          hu: 'Belső címkézés.',
          en: 'Inside labeling.', de: 'Innenetikettierung.', ko: '내부 라벨링.', zh: '内表面贴标。',
        },
        longDescription: {
          ...
          en: 'Applies labels in real time from all sides onto inner surfaces of profiles and pipes. A rotary cylinder pivots the pad to the application level and a stroke cylinder places the label exactly on spot. The blow-on pad applies the label from 5–10 mm away by a blast of air.', de: 'Bringt Etiketten in Echtzeit von allen Seiten auf Innenflächen von Profilen und Rohren auf. Ein Drehzylinder schwenkt den Stempel auf die Etikettierebene, ein Hubzylinder setzt das Etikett exakt an die richtige Stelle. Der Blasstempel bringt das Etikett aus 5–10 mm Entfernung per Luftstoß auf.', ko: '프로파일과 파이프의 내부 표면에 모든 면에서 실시간으로 라벨을 부착합니다. 로터리 실린더가 패드를 부착 높이까지 회전시키고 스트로크 실린더가 라벨을 정확한 지점에 부착합니다. 블로우온 패드는 5–10 mm 거리에서 공기 분사로 라벨을 부착합니다.', zh: '可从各个方向向型材与管材的内表面实时贴标。回转气缸将吸盘摆动至贴标平面，行程气缸将标签精确贴至指定位置。吹贴吸盘可在 5–10 mm 距离外以气流将标签吹贴到位。',
        },
        params: [
          { label: { hu: 'Címkeszélesség', en: 'Label width', de: 'Etikettenbreite', ko: '라벨 폭', zh: '标签宽度' }, value: { hu: '10–80 mm', en: '10–80 mm', de: '10–80 mm', ko: '10–80 mm', zh: '10–80 mm' } },
          { label: { hu: 'Címkemagasság', en: 'Label height', de: 'Etikettenhöhe', ko: '라벨 높이', zh: '标签高度' }, value: { hu: '10–60 mm', en: '10–60 mm', de: '10–60 mm', ko: '10–60 mm', zh: '10–60 mm' } },
          { label: { hu: 'Termék állapota', en: 'Product state', de: 'Produktzustand', ko: '제품 상태', zh: '产品状态' }, value: { hu: 'álló', en: 'at rest', de: 'im Stillstand', ko: '정지 상태', zh: '静止' } },
          { label: { hu: 'Felhelyezés iránya', en: 'Application direction', de: 'Etikettierrichtung', ko: '부착 방향', zh: '贴标方向' }, value: { hu: 'felülről, alulról, oldalról (belső felületre is)', en: 'from top, below, side (inner surfaces too)', de: 'von oben, unten, seitlich (auch Innenflächen)', ko: '상단, 하단, 측면에서(내부 표면 포함)', zh: '从顶部、底部、侧面（含内表面）' } },
          { label: { hu: 'Termékmagasság', en: 'Product height', de: 'Produkthöhe', ko: '제품 높이', zh: '产品高度' }, value: { hu: 'egyenletes', en: 'uniform', de: 'einheitlich', ko: '균일', zh: '一致' } },
          { label: { hu: 'Függőleges elfordulás', en: 'Vertical pivot', de: 'Vertikaler Schwenk', ko: '수직 피벗', zh: '垂直摆动' }, value: { hu: '120°', en: '120°', de: '120°', ko: '120°', zh: '120°' } },
          { label: { hu: 'Távolság a címke felső széléig', en: 'Distance to upper label edge', de: 'Abstand zur oberen Etikettenkante', ko: '라벨 상단 가장자리까지의 거리', zh: '距标签上缘距离' }, value: { hu: 'max. 150–350 mm', en: 'up to 150–350 mm', de: 'bis 150–350 mm', ko: '최대 150–350 mm', zh: '最大 150–350 mm' } },
          { label: { hu: 'Ciklusidő', en: 'Cycle rate', de: 'Taktrate', ko: '사이클 속도', zh: '贴标节拍' }, value: { hu: '~20 címke/perc', en: '~20 labels/min', de: 'ca. 20 Etiketten/min', ko: '약 20매/분', zh: '约 20 张/分钟' } },
          { label: { hu: 'Sűrített levegő', en: 'Compressed air', de: 'Druckluft', ko: '압축 공기', zh: '压缩空气' }, value: { hu: '4,5 bar', en: '4.5 bar', de: '4,5 bar', ko: '4.5 bar', zh: '4.5 bar' } },
          { label: { hu: 'Teljesítményfelvétel', en: 'Power consumption', de: 'Leistungsaufnahme', ko: '소비 전력', zh: '功耗' }, value: { hu: 'max. 15 W', en: 'max. 15 W', de: 'max. 15 W', ko: '최대 15 W', zh: '最大 15 W' } },
          { label: { hu: 'Tömeg', en: 'Weight', de: 'Gewicht', ko: '중량', zh: '重量' }, value: { hu: '6–7 kg', en: '6–7 kg', de: '6–7 kg', ko: '6–7 kg', zh: '6–7 kg' } },
        ],
        videoId: 'mzq7QKgfb1Q',
      },
    ],
  },
  {
    ...
    short: {
      ...
      en: 'The smallest servo-driven labeling head in its class for automated lines.', de: 'Der kleinste servogetriebene Etikettierkopf seiner Klasse für automatisierte Linien.', ko: '자동화 라인을 위한 동급 최소형 서보 구동 라벨링 헤드.', zh: '同级别中最小的伺服驱动贴标头，适用于自动化产线。',
    },
    description: {
...

  {
    ...
    short: {
      ...
      en: 'Labeling head for precision insert-labeling — films, membranes, seals.', de: 'Etikettierkopf für präzises Einlege-Etikettieren — Folien, Membranen, Dichtungen.', ko: '정밀 인서트 라벨링용 라벨링 헤드 — 필름, 멤브레인, 씰.', zh: '用于精密嵌入式贴标的贴标头——薄膜、隔膜、密封件。',
    },
    description: {
      ...
      en: 'The ROXI is a solidly built labeling head with modern electronics and usability for precise insert-labeling — small in price, great in performance. The label web can run up to 30 m/min, roll diameter up to 310 mm, material width up to 180 mm; both vertical and horizontal installation are possible. With HERMES HQ applicators it also labels items at rest and serves high-accuracy industrial applications. Shares its software and firmware base with the IXOR+ head.', de: 'Der ROXI ist ein solide gebauter Etikettierkopf mit moderner Elektronik und Bedienbarkeit für präzises Einlege-Etikettieren — klein im Preis, groß in der Leistung. Die Etikettenbahn läuft mit bis zu 30 m/min, Rollendurchmesser bis 310 mm, Materialbreite bis 180 mm; vertikaler und horizontaler Einbau sind möglich. Mit HERMES HQ Applikatoren etikettiert er auch ruhende Objekte und bedient hochgenaue Industrieanwendungen. Teilt sich die Software- und Firmwarebasis mit dem Etikettierkopf IXOR+.', ko: 'ROXI는 현대적인 전자 플랫폼과 편의성을 갖춘 견고한 구조의 정밀 인서트 라벨링용 라벨링 헤드입니다 — 가격은 낮고 성능은 뛰어납니다. 라벨 웹은 최대 30 m/min으로 구동되며, 롤 직경 최대 310 mm, 소재 폭 최대 180 mm를 지원하고 수직 및 수평 설치가 모두 가능합니다. HERMES HQ 어플리케이터와 함께 사용하면 정지 상태의 제품에도 라벨을 부착할 수 있어 고정밀 산업 애플리케이션에도 대응합니다. IXOR+ 헤드와 소프트웨어 및 펌웨어 기반을 공유합니다.', zh: 'ROXI 是一款结构坚固的贴标头，配备现代化电子系统并且易于使用，专为精密嵌入式贴标而设计——价格不高，性能出众。标签走带速度最高 30 m/min，卷径最大 310 mm，材料宽度最大 180 mm；支持垂直与水平两种安装方式。配合 HERMES HQ 贴标模块还可为静止物品贴标，满足高精度工业应用需求。与 IXOR+ 贴标头共享软件与固件基础。',
    },
    features: [
      { hu: 'Precíziós behelyező-címkézés', en: 'Precision insert-labeling', de: 'Präzises Einlege-Etikettieren', ko: '정밀 인서트 라벨링', zh: '精密嵌入式贴标' },
      { hu: 'Szalagsebesség akár 30 m/perc', en: 'Web speed up to 30 m/min', de: 'Bahngeschwindigkeit bis 30 m/min', ko: '웹 속도 최대 30 m/min', zh: '走带速度最高 30 m/min' },
      { hu: 'Tekercs max. 310 mm, anyagszélesség max. 180 mm', en: 'Roll up to 310 mm, material width up to 180 mm', de: 'Rolle bis 310 mm, Materialbreite bis 180 mm', ko: '롤 최대 310 mm, 소재 폭 최대 180 mm', zh: '卷径最大 310 mm，材料宽度最大 180 mm' },
      { hu: 'HERMES HQ applikátorokkal', en: 'Works with HERMES HQ applicators', de: 'Kompatibel mit HERMES HQ Applikatoren', ko: 'HERMES HQ 어플리케이터와 호환', zh: '兼容 HERMES HQ 贴标模块' },
      { hu: 'Függőleges és vízszintes beépítés', en: 'Vertical and horizontal installation', de: 'Vertikaler und horizontaler Einbau', ko: '수직 및 수평 설치', zh: '垂直与水平安装' },
    ],
  ...
  },
  {
    ...
    short: {
      ...
      en: 'Print-and-peel module for automated machines and applicators.', de: 'Druck- und Spendemodul für automatisierte Maschinen und Applikatoren.', ko: '자동화 머신 및 어플리케이터를 위한 프린트 앤드 필 모듈.', zh: '面向自动化设备与贴标模块的打印剥离模块。',
    },
    description: {
  ...
  },
  {
    ...
    short: {
      ...
      en: 'The world’s first two-colour print & apply system — for GHS hazard labels.', de: 'Das weltweit erste zweifarbige Print-and-Apply-System — für GHS-Gefahrstoffetiketten.', ko: '세계 최초의 2색 프린트 & 어플라이 시스템 — GHS 위험물 라벨용.', zh: '全球首套双色打印贴标系统——适用于 GHS 危险品标签。',
    },
    description: {
  ...
  // ——— CAB — Címke-adagoló gépek ———
  {
    ...
    short: {
      ...
      en: 'Label dispenser for every label size — for gap-free cut or die-cut labels.', de: 'Etikettenspender für jede Etikettengröße — für lückenlos geschnittene oder gestanzte Etiketten.', ko: '모든 라벨 크기에 대응하는 라벨 디스펜서 — 간격 없이 컷팅된 라벨 또는 다이컷 라벨용.', zh: '适用于各种标签尺寸的标签剥离机——支持无间隔切割或模切标签。',
    },
    description: {
      ...
      en: 'The HS dispenser feeds any label size with ease; labels can be die-cut or cut without any gap in between, speeding up manual application.', de: 'Der HS-Spender führt jede Etikettengröße mühelos zu; Etiketten können gestanzt oder ohne Zwischenabstand geschnitten sein, was die manuelle Etikettierung beschleunigt.', ko: 'HS 디스펜서는 어떤 크기의 라벨도 손쉽게 공급합니다. 라벨은 다이컷 형태 또는 간격 없이 컷팅된 형태 모두 사용할 수 있어 수동 부착 작업 속도를 높입니다.', zh: 'HS 剥离机可轻松送出任何尺寸的标签；标签可为模切标签，也可为无间隔切割的标签，从而加快手工贴标速度。',
    },
    features: [
      { hu: 'Bármilyen címkeméret', en: 'Any label size', de: 'Jede Etikettengröße', ko: '모든 라벨 크기', zh: '任意标签尺寸' },
      { hu: 'Hézag nélküli adagolás', en: 'Gap-free dispensing', de: 'Lückenloses Spenden', ko: '간격 없는 디스펜싱', zh: '无间隔剥离' },
      { hu: 'Fotocellás vezérlés', en: 'Photocell control', de: 'Fotozellensteuerung', ko: '포토셀 제어', zh: '光电传感器控制' },
      { hu: 'Asztali kivitel', en: 'Desktop unit', de: 'Tischgerät', ko: '데스크톱 유닛', zh: '桌面型设备' },
    ],
  },
  {
    slug: 'cab-vs',
    ...
    short: {
      ...
      en: 'Compact label dispenser for workstations — simple, fast manual labeling.', de: 'Kompakter Etikettenspender für Arbeitsplätze — einfache, schnelle manuelle Etikettierung.', ko: '작업대용 컴팩트 라벨 디스펜서 — 간편하고 빠른 수동 라벨링.', zh: '面向工位的紧凑型标签剥离机——简单快捷的手工贴标。',
    },
    description: {
      hu: 'A VS adagoló kompakt kivitelben gyorsítja a kézi címkézést munkaállomásokon, megbízható címkeleválasztással.',
      en: 'The VS dispenser accelerates manual labeling at workstations in a compact format, with reliable label separation.', de: 'Der VS-Spender beschleunigt die manuelle Etikettierung am Arbeitsplatz in kompaktem Format, mit zuverlässiger Etikettentrennung.', ko: 'VS 디스펜서는 컴팩트한 형태로 작업대에서의 수동 라벨링을 가속하며, 신뢰성 있는 라벨 분리 기능을 제공합니다.', zh: 'VS 剥离机以紧凑的机身加快工位上的手工贴标速度，标签分离可靠。',
    },
    features: [
      { hu: 'Kompakt asztali kivitel', en: 'Compact desktop unit', de: 'Kompaktes Tischgerät', ko: '컴팩트 데스크톱 유닛', zh: '紧凑型桌面设备' },
      { hu: 'Megbízható címkeleválasztás', en: 'Reliable label separation', de: 'Zuverlässige Etikettentrennung', ko: '신뢰성 있는 라벨 분리', zh: '可靠的标签分离' },
      { hu: 'Állítható különböző méretekhez', en: 'Adjustable for various sizes', de: 'Einstellbar für verschiedene Größen', ko: '다양한 크기에 맞게 조정 가능', zh: '可调节适配多种尺寸' },
      { hu: 'Munkaállomási használat', en: 'Workstation use', de: 'Einsatz am Arbeitsplatz', ko: '작업대 사용', zh: '工位使用' },
    ],
  },
  ...
  // ——— CAB — Lézeres jelölők ———
  {
    ...
    short: {
      ...
      en: 'Fiber marking laser (20/30/50 W) for metals, plastics and painted surfaces.', de: 'Faser-Markierlaser (20/30/50 W) für Metalle, Kunststoffe und lackierte Oberflächen.', ko: '금속, 플라스틱 및 도장 표면용 파이버 마킹 레이저(20/30/50 W).', zh: '光纤打标激光器（20/30/50 W），适用于金属、塑料与喷漆表面。',
    },
    description: {
      ...
      en: 'The XENO 4 is a new-generation fiber laser with 20, 30 or 50 W output power — diode-pumped and air-cooled. It consists of two units: a control unit with an integral beam source, and a scan head connected via a fiber that can be mounted in any orientation. The integrated focus finder simplifies workpiece positioning; different plano-spherical lenses cover marking fields from 69×69 mm to 290×290 mm. Industry 4.0-ready with TCP/IP control and monitoring. Marks metal, plastics and painted surfaces.', de: 'Der XENO 4 ist ein Faserlaser der neuen Generation mit 20, 30 oder 50 W Ausgangsleistung — diodengepumpt und luftgekühlt. Er besteht aus zwei Einheiten: einer Steuereinheit mit integrierter Strahlquelle und einem über eine Faser verbundenen Scankopf, der in beliebiger Ausrichtung montiert werden kann. Der integrierte Fokusfinder vereinfacht die Positionierung des Werkstücks; verschiedene plansphärische Linsen decken Markierfelder von 69×69 mm bis 290×290 mm ab. Industrie-4.0-fähig mit Steuerung und Überwachung über TCP/IP. Markiert Metall, Kunststoffe und lackierte Oberflächen.', ko: 'XENO 4는 20, 30 또는 50 W 출력의 신세대 파이버 레이저로, 다이오드 펌핑 방식과 공랭식을 채택했습니다. 빔 소스 일체형 컨트롤 유닛과, 파이버로 연결되어 어떤 방향으로도 장착할 수 있는 스캔 헤드의 두 유닛으로 구성됩니다. 통합 포커스 파인더가 공작물 위치 설정을 간소화하며, 다양한 평면 구면 렌즈로 69×69 mm에서 290×290 mm까지의 마킹 필드를 커버합니다. TCP/IP 제어 및 모니터링으로 Industry 4.0에 대응합니다. 금속, 플라스틱, 도장 표면을 마킹합니다.', zh: 'XENO 4 是新一代光纤激光器，输出功率 20、30 或 50 W——二极管泵浦、风冷设计。由两个单元组成：内置光束源的控制单元，以及通过光纤连接、可以任意方向安装的扫描头。集成的焦点定位器简化工件定位；不同的平面球面透镜可覆盖 69×69 mm 至 290×290 mm 的打标范围。支持工业 4.0，可通过 TCP/IP 控制与监控。可打标金属、塑料与喷漆表面。',
    },
    features: [
      { hu: '20 / 30 / 50 W ytterbium fiber lézer, léghűtéses', en: '20 / 30 / 50 W ytterbium fiber laser, air-cooled', de: '20 / 30 / 50 W Ytterbium-Faserlaser, luftgekühlt', ko: '20 / 30 / 50 W 이터븀 파이버 레이저, 공랭식', zh: '20 / 30 / 50 W 镱光纤激光器，风冷' },
      { hu: 'Jelölőmező 69×69 – 290×290 mm (objektívtől függően)', en: 'Marking field 69×69 – 290×290 mm (lens-dependent)', de: 'Markierfeld 69×69 – 290×290 mm (linsenabhängig)', ko: '마킹 필드 69×69 – 290×290 mm(렌즈별 상이)', zh: '打标范围 69×69 – 290×290 mm（视透镜而定）' },
      { hu: 'Integrált fókuszkereső, kompakt szkennerfej', en: 'Integrated focus finder, compact scan head', de: 'Integrierter Fokusfinder, kompakter Scankopf', ko: '통합 포커스 파인더, 컴팩트 스캔 헤드', zh: '集成焦点定位器，紧凑型扫描头' },
      { hu: 'Jelölési sebesség > 5000 mm/s', en: 'Marking speed > 5,000 mm/s', de: 'Markiergeschwindigkeit > 5.000 mm/s', ko: '마킹 속도 5,000 mm/s 초과', zh: '打标速度 > 5,000 mm/s' },
      { hu: 'Ipar 4.0, TCP/IP vezérlés és felügyelet', en: 'Industry 4.0, TCP/IP control and monitoring', de: 'Industrie 4.0, Steuerung und Überwachung über TCP/IP', ko: 'Industry 4.0, TCP/IP 제어 및 모니터링', zh: '工业 4.0，TCP/IP 控制与监控' },
      { hu: 'cabLase jelölőszoftver', en: 'cabLase marking software', de: 'cabLase Markiersoftware', ko: 'cabLase 마킹 소프트웨어', zh: 'cabLase 打标软件' },
    ],
  ...
  },
  {
    ...
    short: {
      ...
      en: 'Compact all-in-one desktop laser marking system for metal and plastic.', de: 'Kompaktes All-in-One-Desktop-Lasermarkiersystem für Metall und Kunststoff.', ko: '금속 및 플라스틱용 컴팩트 올인원 데스크톱 레이저 마킹 시스템.', zh: '紧凑型一体化桌面激光打标系统，适用于金属与塑料。',
    },
    description: {
  ...
  },
  {
    ...
    short: {
      ...
      en: 'Integrated laser system for permanent marking of metal and plastic plates.', de: 'Integriertes Lasersystem zur dauerhaften Markierung von Metall- und Kunststoffplatten.', ko: '금속 및 플라스틱 플레이트의 영구 마킹을 위한 통합형 레이저 시스템.', zh: '用于金属与塑料铭牌永久打标的集成式激光系统。',
    },
    description: {
      ...
      en: 'The XENO 3 is an integrated laser system for permanently marking metal and plastic plates (type plates). The fiber beam source, control unit and work area are housed in a joint Class-1 laser safety enclosure; its compact design suits desktop operation. Replaceable magazines process different plate sizes: plates 40×20 – 120×100 mm, 0.5–1 mm thick, stackable up to 50 mm high. Markings by the 20 or 30 W fiber laser stay clearly legible even in rough environments; particularly suited to metal engraving and top-layer ablation.', de: 'Der XENO 3 ist ein integriertes Lasersystem zur dauerhaften Markierung von Metall- und Kunststoffplatten (Typenschildern). Faserstrahlquelle, Steuereinheit und Arbeitsbereich sind in einem gemeinsamen Lasersicherheitsgehäuse der Klasse 1 untergebracht; das kompakte Design eignet sich für den Desktop-Betrieb. Wechselbare Magazine verarbeiten unterschiedliche Plattengrößen: Platten 40×20 – 120×100 mm, 0,5–1 mm dick, stapelbar bis 50 mm Höhe. Markierungen des 20- oder 30-W-Faserlasers bleiben auch in rauen Umgebungen klar lesbar; besonders geeignet für Metallgravur und Deckschicht-Abtrag.', ko: 'XENO 3은 금속 및 플라스틱 플레이트(명판)의 영구 마킹을 위한 통합형 레이저 시스템입니다. 파이버 빔 소스, 컨트롤 유닛, 작업 영역이 하나의 Class 1 레이저 안전 인클로저에 통합되어 있으며, 컴팩트한 설계로 데스크톱 운용에 적합합니다. 교체형 매거진으로 다양한 플레이트 크기를 처리합니다: 플레이트 40×20 – 120×100 mm, 두께 0.5–1 mm, 적층 높이 최대 50 mm. 20 또는 30 W 파이버 레이저의 마킹은 거친 환경에서도 선명하게 판독 가능하며, 특히 금속 각인과 상부 레이어 제거에 적합합니다.', zh: 'XENO 3 是一套用于金属与塑料铭牌（型号牌）永久打标的集成式激光系统。光纤光束源、控制单元与工作区共同置于 1 类激光安全防护罩内；紧凑的设计适合桌面使用。可更换料匣可处理不同尺寸的铭牌：铭牌尺寸 40×20 – 120×100 mm，厚度 0.5–1 mm，堆叠高度最大 50 mm。20 或 30 W 光纤激光器的打标即使在恶劣环境下也能保持清晰可读；尤其适合金属雕刻与表层剥蚀。',
    },
    features: [
      { hu: 'Integrált táblajelölő rendszer (1. lézerosztály)', en: 'Integrated plate-marking system (Class 1)', de: 'Integriertes Platten-Markiersystem (Klasse 1)', ko: '통합형 플레이트 마킹 시스템(Class 1)', zh: '集成式铭牌打标系统（1 类激光）' },
      { hu: '20 / 30 W fiber lézer', en: '20 / 30 W fiber laser', de: '20 / 30 W Faserlaser', ko: '20 / 30 W 파이버 레이저', zh: '20 / 30 W 光纤激光器' },
      { hu: 'Táblaméret 40×20 – 120×100 mm, 0,5–1 mm vastag', en: 'Plate size 40×20 – 120×100 mm, 0.5–1 mm thick', de: 'Plattengröße 40×20 – 120×100 mm, 0,5–1 mm dick', ko: '플레이트 크기 40×20 – 120×100 mm, 두께 0.5–1 mm', zh: '铭牌尺寸 40×20 – 120×100 mm，厚度 0.5–1 mm' },
      { hu: 'Cserélhető magazinok, akár 50 mm kötegmagasság', en: 'Replaceable magazines, up to 50 mm stack height', de: 'Wechselbare Magazine, bis 50 mm Stapelhöhe', ko: '교체형 매거진, 적층 높이 최대 50 mm', zh: '可更换料匣，堆叠高度最大 50 mm' },
      { hu: 'Tartós, jól olvasható jelölés zord környezetben', en: 'Durable, legible marking in harsh environments', de: 'Dauerhafte, lesbare Markierung in rauen Umgebungen', ko: '거친 환경에서도 판독 가능한 내구성 있는 마킹', zh: '恶劣环境下依然持久清晰的打标' },
      { hu: 'cabLase szoftver, hálózati vezérlés', en: 'cabLase software, network control', de: 'cabLase Software, Netzwerksteuerung', ko: 'cabLase 소프트웨어, 네트워크 제어', zh: 'cabLase 软件，网络控制' },
    ],
  ...
  },
  {
    ...
    short: {
      ...
      en: 'Laser label marker & cutter: various label sizes straight from the roll.', de: 'Laser-Etikettenmarkierer & -schneider: verschiedene Etikettengrößen direkt von der Rolle.', ko: '레이저 라벨 마커 & 커터: 롤에서 바로 다양한 크기의 라벨 제작.', zh: '激光标签打标与切割机：直接从卷料打标多种尺寸的标签。',
    },
    description: {
  ...
  },
  {
    ...
    short: {
      ...
      en: 'Class-1 laser marking station for series production, with XENO 4.', de: 'Lasermarkierstation der Klasse 1 für die Serienproduktion, mit XENO 4.', ko: 'XENO 4를 탑재한 양산용 Class 1 레이저 마킹 스테이션.', zh: '面向批量生产的 1 类激光打标工作站，搭载 XENO 4。',
    },
    description: {
      ...
      en: 'The LSG+100E laser safety housing is an industrial solution for series marking of parts with the XENO 4 fiber laser. Rugged metal design with a large 980×460×980 mm work area; the 19" rack fits the beam source and an industrial PC. Motor-driven door (<2 s open/close), a 440 mm-stroke Z-axis, 0.02 mm positioning accuracy and up to 50 kg workpiece weight. Class 1, CE approved.', de: 'Das Lasersicherheitsgehäuse LSG+100E ist eine Industrielösung für die Serienmarkierung von Teilen mit dem Faserlaser XENO 4. Robuste Metallkonstruktion mit großem Arbeitsbereich von 980×460×980 mm; das 19"-Rack nimmt die Strahlquelle und einen Industrie-PC auf. Motorische Tür (<2 s Öffnen/Schließen), Z-Achse mit 440 mm Hub, 0,02 mm Positioniergenauigkeit und bis zu 50 kg Werkstückgewicht. Klasse 1, CE-zugelassen.', ko: 'LSG+100E 레이저 안전 하우징은 XENO 4 파이버 레이저로 부품을 연속 마킹하기 위한 산업용 솔루션입니다. 980×460×980 mm의 넓은 작업 영역을 갖춘 견고한 금속 설계이며, 19" 랙에 빔 소스와 산업용 PC를 장착할 수 있습니다. 전동 도어(개폐 2초 미만), 440 mm 스트로크 Z축, 0.02 mm 위치 정밀도, 최대 50 kg의 공작물 중량을 지원합니다. Class 1, CE 인증.', zh: 'LSG+100E 激光安全防护罩是使用 XENO 4 光纤激光器批量打标零件的工业解决方案。坚固的金属结构，工作区域达 980×460×980 mm；19" 机架可容纳光束源与工业 PC。电动门（开/关小于 2 秒）、440 mm 行程 Z 轴、0.02 mm 定位精度，工件重量最大 50 kg。1 类激光，通过 CE 认证。',
    },
    features: [
      { hu: '1. lézerosztályú ipari jelölőállomás', en: 'Class-1 industrial marking station', de: 'Industrielle Markierstation der Klasse 1', ko: 'Class 1 산업용 마킹 스테이션', zh: '1 类激光工业打标工作站' },
      { hu: 'Sorozatjelölés XENO 4-gyel', en: 'Series marking with XENO 4', de: 'Serienmarkierung mit XENO 4', ko: 'XENO 4를 이용한 연속 마킹', zh: '使用 XENO 4 进行批量打标' },
      { hu: 'Munkatér 980×460×980 mm, Z-löket 440 mm', en: 'Work area 980×460×980 mm, Z-stroke 440 mm', de: 'Arbeitsbereich 980×460×980 mm, Z-Hub 440 mm', ko: '작업 영역 980×460×980 mm, Z 스트로크 440 mm', zh: '工作区域 980×460×980 mm，Z 轴行程 440 mm' },
      { hu: 'Motoros ajtó, 0,02 mm pozicionálás', en: 'Motor-driven door, 0.02 mm positioning', de: 'Motorische Tür, 0,02 mm Positionierung', ko: '전동 도어, 0.02 mm 위치 정밀도', zh: '电动门，0.02 mm 定位精度' },
      { hu: '19"-os rack a lézerforrásnak és ipari PC-nek', en: '19" rack for laser source & industrial PC', de: '19"-Rack für Strahlquelle & Industrie-PC', ko: '레이저 소스 및 산업용 PC용 19" 랙', zh: '19" 机架容纳激光源与工业 PC' },
    ],
  ...
  },
  {
    ...
    short: {
      ...
      en: 'Extraction and filter system for laser marking — protects operator and optics.', de: 'Absaug- und Filtersystem für die Lasermarkierung — schützt Bediener und Optik.', ko: '레이저 마킹용 집진·필터 시스템 — 작업자와 광학계를 보호합니다.', zh: '激光打标用抽排过滤系统——保护操作人员与光学部件。',
    },
    description: {
  ...
  // ——— CAB — Szoftver ———
  {
    ...
    short: {
      ...
      en: 'cab label design and printing software with full device control.', de: 'cab Software für Etikettengestaltung und -druck mit voller Gerätesteuerung.', ko: '장비를 완전하게 제어하는 cab 라벨 디자인 및 인쇄 소프트웨어.', zh: 'cab 标签设计与打印软件，具备完整的设备控制功能。',
    },
    description: {
      ...
      en: 'cablabel S3 is cab’s own label design software: a WYSIWYG editor, database connectivity and full control of cab printers, print & apply systems and lasers from a single interface.', de: 'cablabel S3 ist die hauseigene Etikettensoftware von cab: WYSIWYG-Editor, Datenbankanbindung und volle Steuerung von cab Druckern, Print-and-Apply-Systemen und Lasern über eine einzige Oberfläche.', ko: 'cablabel S3는 cab의 자체 라벨 디자인 소프트웨어입니다. WYSIWYG 에디터, 데이터베이스 연결, 그리고 단일 인터페이스에서 cab 프린터, 프린트 & 어플라이 시스템, 레이저를 완전하게 제어합니다.', zh: 'cablabel S3 是 cab 自主开发的标签设计软件：WYSIWYG 编辑器、数据库连接，并可在单一界面中全面控制 cab 打印机、打印贴标系统与激光器。',
    },
    features: [
      { hu: 'WYSIWYG címketervező', en: 'WYSIWYG label editor', de: 'WYSIWYG-Etiketteneditor', ko: 'WYSIWYG 라벨 에디터', zh: 'WYSIWYG 标签编辑器' },
      { hu: 'Adatbázis-kapcsolat', en: 'Database connectivity', de: 'Datenbankanbindung', ko: '데이터베이스 연결', zh: '数据库连接' },
      { hu: 'Nyomtató, print & apply és lézer vezérlés', en: 'Controls printers, print & apply and lasers', de: 'Steuert Drucker, Print & Apply und Laser', ko: '프린터, 프린트 & 어플라이 시스템, 레이저 제어', zh: '控制打印机、打印贴标系统与激光器' },
      { hu: 'Több kiadásban', en: 'Available in multiple editions', de: 'In mehreren Editionen erhältlich', ko: '다양한 에디션으로 제공', zh: '提供多种版本' },
    ],
  ...
  },
  {
    ...
    short: {
      ...
      en: 'One of the world’s most widely used label design and printing software, by Loftware.', de: 'Eine der weltweit meistgenutzten Softwarelösungen für Etikettengestaltung und -druck, von Loftware.', ko: 'Loftware가 제공하는, 세계에서 가장 널리 사용되는 라벨 디자인 및 인쇄 소프트웨어 중 하나.', zh: '全球使用最广泛的标签设计与打印软件之一，由 Loftware 出品。',
    },
    description: {
  ...
  },
  {
    ...
    short: {
      ...
      en: 'Custom software designed and built around your processes.', de: 'Individuelle Software, entworfen und entwickelt rund um Ihre Prozesse.', ko: '귀사의 프로세스에 맞춰 설계하고 구축하는 맞춤형 소프트웨어.', zh: '围绕您的流程设计与开发的定制软件。',
    },
    description: {
      ...
      en: 'We design and build custom software — from automating labeling and marking workflows to database and system integration, tailored entirely to your needs.', de: 'Wir entwerfen und entwickeln individuelle Software — von der Automatisierung von Etikettier- und Markierabläufen bis zur Datenbank- und Systemintegration, ganz auf Ihre Anforderungen zugeschnitten.', ko: '라벨링 및 마킹 워크플로 자동화부터 데이터베이스 및 시스템 통합까지, 귀사의 요구에 전적으로 맞춘 맞춤형 소프트웨어를 설계하고 구축합니다.', zh: '我们设计并开发定制软件——从贴标与打标流程自动化到数据库与系统集成，完全按照您的需求量身打造。',
    },
    features: [
      { hu: 'Igény szerinti fejlesztés', en: 'Development to your requirements', de: 'Entwicklung nach Ihren Anforderungen', ko: '요구 사항에 맞춘 개발', zh: '按您的需求开发' },
      { hu: 'Munkafolyamat-automatizálás', en: 'Workflow automation', de: 'Workflow-Automatisierung', ko: '워크플로 자동화', zh: '工作流程自动化' },
      { hu: 'Adatbázis- és rendszerintegráció', en: 'Database and system integration', de: 'Datenbank- und Systemintegration', ko: '데이터베이스 및 시스템 통합', zh: '数据库与系统集成' },
      { hu: 'Címke- és jelölésvezérlés', en: 'Label and marking control', de: 'Etiketten- und Markiersteuerung', ko: '라벨 및 마킹 제어', zh: '标签与打标控制' },
    ],
  },
  ...
  // ——— POSTEK — címkenyomtató sorozatok ———
  {
    ...
    extraVideos: [
      {
        ...
        label: {
          ...
          en: 'Automatic head opening and pressure adjustment', de: 'Automatische Kopföffnung und Anpressdruck-Justierung', ko: '자동 헤드 개방 및 압력 조정', zh: '自动打印头开合与压力调节',
        },
      },
    ],
    ...
    short: {
      ...
      en: 'Flagship industrial printer with integrated visual verification and RFID.', de: 'Flaggschiff-Industriedrucker mit integrierter visueller Verifizierung und RFID.', ko: '통합 비주얼 검증과 RFID를 갖춘 플래그십 산업용 프린터.', zh: '旗舰级工业打印机，集成视觉检测与 RFID。',
    },
    description: {
    ...
    features: [
      { hu: '200 / 300 / 600 dpi', en: '200 / 300 / 600 dpi', de: '200 / 300 / 600 dpi', ko: '200 / 300 / 600 dpi', zh: '200 / 300 / 600 dpi' },
      { hu: 'Akár 18 ips sebesség', en: 'Up to 18 ips', de: 'Bis zu 18 ips', ko: '최대 18 ips', zh: '最高 18 ips' },
      { hu: 'Integrált 1D/2D vizuális ellenőrzés', en: 'Integrated 1D/2D visual verification', de: 'Integrierte visuelle 1D-/2D-Verifizierung', ko: '통합 1D/2D 비주얼 검증', zh: '集成一维/二维视觉检测' },
      { hu: '4,5" érintőkijelző', en: '4.5" touchscreen', de: '4,5"-Touchscreen', ko: '4.5" 터치스크린', zh: '4.5" 触摸屏' },
      { hu: 'Opcionális RFID', en: 'Optional RFID', de: 'Optionales RFID', ko: '옵션 RFID', zh: '可选 RFID' },
    ],
  },
  {
    slug: 'postek-tx',
    ...
    short: {
      ...
      en: 'True industrial printer with HEAT™ technology for heavy-duty use.', de: 'Echter Industriedrucker mit HEAT™-Technologie für den harten Dauereinsatz.', ko: '고부하 사용을 위한 HEAT™ 기술의 진정한 산업용 프린터.', zh: '搭载 HEAT™ 技术的真正工业级打印机，适合重载使用。',
    },
    description: {
    ...
    features: [
      { hu: '203 / 300 / 600 dpi modellek', en: '203 / 300 / 600 dpi models', de: '203 / 300 / 600 dpi Modelle', ko: '203 / 300 / 600 dpi 모델', zh: '203 / 300 / 600 dpi 型号' },
      { hu: 'HEAT™ nyomtatási minőség', en: 'HEAT™ print quality', de: 'HEAT™-Druckqualität', ko: 'HEAT™ 인쇄 품질', zh: 'HEAT™ 打印品质' },
      { hu: 'ADAPT™ ±0,5 mm pozicionálás', en: 'ADAPT™ ±0.5 mm positioning', de: 'ADAPT™ ±0,5 mm Positionierung', ko: 'ADAPT™ ±0.5 mm 포지셔닝', zh: 'ADAPT™ ±0.5 mm 定位' },
      { hu: '4,5" színes érintőkijelző', en: '4.5" color touchscreen', de: '4,5"-Farb-Touchscreen', ko: '4.5" 컬러 터치스크린', zh: '4.5" 彩色触摸屏' },
      { hu: 'Direkt termál és termotranszfer', en: 'Direct thermal & thermal transfer', de: 'Thermodirekt- & Thermotransferdruck', ko: '감열 & 열전사', zh: '热敏与热转印' },
    ],
  },
  {
    slug: 'postek-gx',
    ...
    short: {
      ...
      en: 'Desktop format with industrial performance in a compact footprint.', de: 'Desktop-Format mit Industrieleistung auf kompakter Stellfläche.', ko: '컴팩트한 설치 면적에 산업용 성능을 담은 데스크톱 포맷.', zh: '桌面尺寸，工业性能，占地紧凑。',
    },
    description: {
  ...
  },
  {
    ...
    short: {
      ...
      en: 'Commercial desktop printer for simple, everyday labeling.', de: 'Kommerzieller Desktop-Drucker für die einfache, tägliche Etikettierung.', ko: '간편한 일상 라벨링을 위한 상업용 데스크톱 프린터.', zh: '面向日常简单标签打印的商用桌面打印机。',
    },
    description: {
    ...
    features: [
      { hu: 'Kompakt, egyrészes váz', en: 'Compact one-piece chassis', de: 'Kompaktes einteiliges Chassis', ko: '컴팩트 일체형 섀시', zh: '紧凑的一体式机身' },
      { hu: '203 / 300 dpi modellek', en: '203 / 300 dpi models', de: '203 / 300 dpi Modelle', ko: '203 / 300 dpi 모델', zh: '203 / 300 dpi 型号' },
      { hu: '4" nyomtatási szélességig', en: 'Up to 4" print width', de: 'Bis zu 4" Druckbreite', ko: '최대 4" 인쇄 폭', zh: '打印宽度最大 4"' },
      { hu: 'Direkt termál és termotranszfer', en: 'Direct thermal & thermal transfer', de: 'Thermodirekt- & Thermotransferdruck', ko: '감열 & 열전사', zh: '热敏与热转印' },
      { hu: 'RS-232 és USB', en: 'RS-232 & USB', de: 'RS-232 & USB', ko: 'RS-232 & USB', zh: 'RS-232 与 USB' },
    ],
  },
  ...
  // ——— TYKMA Electrox — lézeres jelölő- és gravírozórendszerek ———
  {
    ...
    short: {
      ...
      en: 'Benchtop Class 1 fiber laser marker — fast, maintenance-free, for high volumes.', de: 'Faserlaser-Markiergerät der Klasse 1 als Tischgerät — schnell, wartungsfrei, für hohe Stückzahlen.', ko: '벤치탑 Class 1 파이버 레이저 마커 — 빠르고 유지보수가 필요 없는 대량 생산용.', zh: '台式 1 类光纤激光打标机——快速、免维护，适合大批量生产。',
    },
    description: {
      ...
      en: 'The Minilase is a compact Class 1 benchtop fiber laser marking system built for high-volume production. A three-sided pneumatic vertical door with a patented safety system, and an air-cooled, maintenance-free fiber laser source. In Easy mode the door-close / mark / door-open sequence is automated. Motorised focal-height adjustment with a built-in focus finder; an optional rotary device enables 360° radial marking.', de: 'Der Minilase ist ein kompaktes Faserlaser-Markiersystem der Klasse 1 als Tischgerät, gebaut für die Produktion hoher Stückzahlen. Dreiseitige pneumatische Vertikaltür mit patentiertem Sicherheitssystem und luftgekühlte, wartungsfreie Faserlaserquelle. Im Easy-Modus läuft die Sequenz Tür schließen / Markieren / Tür öffnen automatisiert ab. Motorische Fokushöhenverstellung mit integriertem Fokusfinder; eine optionale Dreheinrichtung ermöglicht radiales 360°-Markieren.', ko: 'Minilase는 대량 생산을 위해 제작된 컴팩트한 Class 1 벤치탑 파이버 레이저 마킹 시스템입니다. 특허받은 안전 시스템을 갖춘 3면 공압식 수직 도어와 공랭식·무보수 파이버 레이저 소스를 채택했습니다. Easy 모드에서는 도어 닫힘 / 마킹 / 도어 열림 시퀀스가 자동으로 진행됩니다. 내장 포커스 파인더와 함께 전동식 초점 높이 조정을 제공하며, 옵션 로터리 장치로 360° 원주 마킹이 가능합니다.', zh: 'Minilase 是一款紧凑型 1 类台式光纤激光打标系统，专为大批量生产打造。三面气动升降门配专利安全系统，风冷免维护光纤激光源。在 Easy 模式下，关门/打标/开门流程自动完成。电动焦距调节配内置焦点定位器；可选旋转装置可实现 360° 径向打标。',
    },
    features: [
      { hu: 'Class 1 — nyílt térben is biztonságos', en: 'Class 1 — safe in an open environment', de: 'Klasse 1 — sicher in offener Umgebung', ko: 'Class 1 — 개방 환경에서도 안전', zh: '1 类激光——开放环境下安全使用' },
      { hu: 'MOPA fiber lézer, 20 / 50 W', en: 'MOPA fiber laser, 20 / 50 W', de: 'MOPA-Faserlaser, 20 / 50 W', ko: 'MOPA 파이버 레이저, 20 / 50 W', zh: 'MOPA 光纤激光器，20 / 50 W' },
      { hu: 'Automatikus pneumatikus ajtó', en: 'Automatic pneumatic door', de: 'Automatische pneumatische Tür', ko: '자동 공압식 도어', zh: '自动气动门' },
      { hu: 'Léghűtéses, karbantartásmentes', en: 'Air-cooled, maintenance-free', de: 'Luftgekühlt, wartungsfrei', ko: '공랭식, 유지보수 불필요', zh: '风冷，免维护' },
      { hu: 'Beépített fókuszkereső', en: 'Built-in focus finder', de: 'Integrierter Fokusfinder', ko: '내장 포커스 파인더', zh: '内置焦点定位器' },
      { hu: '36 hónap garancia', en: '36-month warranty', de: '36 Monate Garantie', ko: '36개월 보증', zh: '36 个月保修' },
    ],
  },
  {
    ...
    short: {
      ...
      en: 'Larger, open-interior fiber laser marker — with optional Class 4 operation.', de: 'Größerer Faserlaser-Markierer mit offenem Innenraum — mit optionalem Klasse-4-Betrieb.', ko: '더 크고 내부가 개방된 파이버 레이저 마커 — 옵션으로 Class 4 운용 가능.', zh: '更大的开放式内腔光纤激光打标机——可选 4 类激光运行模式。',
    },
    description: {
      ...
      en: 'The Minilase XL is the largest, open-interior benchtop member of the Minilase line — for marking parts up to 508 mm wide. With a service key and warning light, Class 4 (open-door) marking is also possible. Automatic mode, motorised focal-height adjustment (optionally programmable), available with a variety of laser types (fiber up to 100 W).', de: 'Der Minilase XL ist das größte Tischgerät der Minilase-Linie mit offenem Innenraum — zum Markieren von Teilen bis 508 mm Breite. Mit Serviceschlüssel und Warnleuchte ist auch Klasse-4-Markierung (bei offener Tür) möglich. Automatikmodus, motorische Fokushöhenverstellung (optional programmierbar), erhältlich mit verschiedenen Lasertypen (Faser bis 100 W).', ko: 'Minilase XL은 Minilase 라인 중 가장 크고 내부가 개방된 벤치탑 모델로, 최대 508 mm 폭의 부품을 마킹할 수 있습니다. 서비스 키와 경고등을 사용하면 Class 4(도어 개방) 마킹도 가능합니다. 자동 모드, 전동식 초점 높이 조정(옵션으로 프로그래밍 가능)을 제공하며 다양한 레이저 유형(파이버 최대 100 W)으로 선택할 수 있습니다.', zh: 'Minilase XL 是 Minilase 产品线中尺寸最大、内腔开放的台式机型——可打标最宽 508 mm 的零件。借助服务钥匙与警示灯，还可进行 4 类（开门）打标。自动模式，电动焦距调节（可选编程控制），提供多种激光器类型（光纤最高 100 W）。',
    },
    features: [
      { hu: 'Tág, nyitott munkatér', en: 'Large, open working area', de: 'Großer, offener Arbeitsbereich', ko: '넓고 개방된 작업 영역', zh: '宽敞的开放式工作区域' },
      { hu: 'MOPA fiber lézer, 20–100 W', en: 'MOPA fiber laser, 20–100 W', de: 'MOPA-Faserlaser, 20–100 W', ko: 'MOPA 파이버 레이저, 20–100 W', zh: 'MOPA 光纤激光器，20–100 W' },
      { hu: 'Opcionális Class 4 üzemmód', en: 'Optional Class 4 operation', de: 'Optionaler Klasse-4-Betrieb', ko: '옵션 Class 4 운용', zh: '可选 4 类激光运行模式' },
      { hu: 'Programozható fókusz opció', en: 'Programmable focus option', de: 'Programmierbare Fokusoption', ko: '프로그래밍 가능한 포커스 옵션', zh: '可编程焦距选项' },
      { hu: 'Léghűtéses, karbantartásmentes', en: 'Air-cooled, maintenance-free', de: 'Luftgekühlt, wartungsfrei', ko: '공랭식, 유지보수 불필요', zh: '风冷，免维护' },
      { hu: '36 hónap garancia', en: '36-month warranty', de: '36 Monate Garantie', ko: '36개월 보증', zh: '36 个月保修' },
    ],
  },
  {
    ...
    short: {
      ...
      en: 'Compact fiber integration laser for production lines and work cells.', de: 'Kompakter Faser-Integrationslaser für Produktionslinien und Arbeitszellen.', ko: '생산 라인 및 워크셀을 위한 컴팩트 파이버 통합형 레이저.', zh: '面向生产线与工作单元的紧凑型光纤集成激光器。',
    },
    description: {
      ...
      en: 'The Vereo is a fiber integration laser with an ultra-compact, robust machined-aluminium marking head, designed for integration into automated production lines and custom enclosures. An air-cooled, maintenance-free fiber source; a simple USB connection to a PC, dedicated I/O and marking on the fly.', de: 'Der Vereo ist ein Faser-Integrationslaser mit ultrakompaktem, robustem Markierkopf aus gefrästem Aluminium, konzipiert für die Integration in automatisierte Produktionslinien und kundenspezifische Gehäuse. Luftgekühlte, wartungsfreie Faserquelle; einfache USB-Verbindung zum PC, dedizierte I/O und Marking on the fly.', ko: 'Vereo는 초소형의 견고한 절삭 가공 알루미늄 마킹 헤드를 갖춘 파이버 통합형 레이저로, 자동화 생산 라인과 맞춤형 인클로저에 통합하도록 설계되었습니다. 공랭식·무보수 파이버 소스, PC와의 간편한 USB 연결, 전용 I/O, 온더플라이 마킹을 지원합니다.', zh: 'Vereo 是一款光纤集成激光器，配备超紧凑、坚固的机加工铝制打标头，专为集成到自动化生产线与定制防护罩中而设计。风冷免维护光纤光源；通过简单的 USB 连接 PC，配备专用 I/O，支持飞行打标。',
    },
    features: [
      { hu: 'Ultrakompakt jelölőfej', en: 'Ultra-compact marking head', de: 'Ultrakompakter Markierkopf', ko: '초소형 마킹 헤드', zh: '超紧凑打标头' },
      { hu: 'MOPA fiber lézerforrás', en: 'MOPA fiber laser source', de: 'MOPA-Faserlaserquelle', ko: 'MOPA 파이버 레이저 소스', zh: 'MOPA 光纤激光源' },
      { hu: 'Gyártósori integrációra tervezve', en: 'Designed for line integration', de: 'Konzipiert für Linienintegration', ko: '라인 통합을 위한 설계', zh: '专为产线集成设计' },
      { hu: 'Dedikált I/O, marking on the fly', en: 'Dedicated I/O, marking on the fly', de: 'Dedizierte I/O, Marking on the fly', ko: '전용 I/O, 온더플라이 마킹', zh: '专用 I/O，支持飞行打标' },
      { hu: 'Léghűtéses, karbantartásmentes', en: 'Air-cooled, maintenance-free', de: 'Luftgekühlt, wartungsfrei', ko: '공랭식, 유지보수 불필요', zh: '风冷，免维护' },
    ],
  },
  {
    ...
    short: {
      ...
      en: 'Integration laser without a PC — touchscreen and control from any device.', de: 'Integrationslaser ohne PC — Touchscreen und Steuerung von jedem Gerät.', ko: 'PC가 필요 없는 통합형 레이저 — 터치스크린과 모든 기기에서의 제어.', zh: '无需 PC 的集成激光器——触摸屏操作，任意设备均可控制。',
    },
    description: {
  ...
  },
  {
    ...
    short: {
      ...
      en: 'Compact, entry-level Class 4 fiber laser marker and engraver.', de: 'Kompakter Klasse-4-Faserlaser für Markierung und Gravur im Einstiegssegment.', ko: '컴팩트한 엔트리급 Class 4 파이버 레이저 마커 및 각인기.', zh: '紧凑型入门级 4 类光纤激光打标与雕刻机。',
    },
    description: {
  ...
  // ——— Festékszalagok (termotranszfer) ———
  {
    ...
    short: {
      ...
      en: 'Premium thermal transfer ribbons — in wax, wax/resin and resin.', de: 'Premium-Thermotransfer-Farbbänder — als Wax, Wax-Resin und Resin.', ko: '프리미엄 열전사 리본 — Wax, Wax/Resin 및 Resin 타입.', zh: '高品质热转印碳带——蜡基、混合基与树脂基。',
    },
    description: {
      ...
      en: 'DNP (Dai Nippon Printing) is one of the world’s leading manufacturers of thermal transfer ribbons. A complete range of wax, wax/resin and resin ribbons: from the globally renowned TR4085Plus premium wax to highly resistant resin ribbons. Ideal for shipping, logistics, pharmaceutical, chemical and outdoor labeling, on both paper and synthetic labels.', de: 'DNP (Dai Nippon Printing) ist einer der weltweit führenden Hersteller von Thermotransfer-Farbbändern. Ein komplettes Sortiment an Wax-, Wax-Resin- und Resin-Farbbändern: vom weltweit renommierten Premium-Wax TR4085Plus bis zu hochbeständigen Resin-Farbbändern. Ideal für Versand, Logistik, Pharma-, Chemie- und Außenetikettierung, auf Papier- wie Kunststoffetiketten.', ko: 'DNP(Dai Nippon Printing)는 세계 유수의 열전사 리본 제조사 중 하나입니다. 세계적으로 명성 높은 TR4085Plus 프리미엄 Wax부터 고내구성 Resin 리본까지, Wax, Wax/Resin 및 Resin 리본의 완전한 라인업을 제공합니다. 종이 및 합성수지 라벨 모두에서 배송, 물류, 제약, 화학 및 옥외 라벨링에 이상적입니다.', zh: 'DNP（Dai Nippon Printing）是全球领先的热转印碳带制造商之一。提供完整的蜡基、混合基与树脂基碳带系列：从享誉全球的 TR4085Plus 高级蜡基碳带到高耐性树脂基碳带。是运输、物流、制药、化工与户外标签打印的理想选择，适用于纸质与合成标签。',
    },
    features: [
      { hu: 'Wax, wax/resin és resin kivitel', en: 'Wax, wax/resin and resin grades', de: 'Wax-, Wax-Resin- und Resin-Qualitäten', ko: 'Wax, Wax/Resin 및 Resin 등급', zh: '蜡基、混合基与树脂基等级' },
      { hu: 'TR4085Plus prémium wax szalag', en: 'TR4085Plus premium wax ribbon', de: 'TR4085Plus Premium-Wax-Farbband', ko: 'TR4085Plus 프리미엄 Wax 리본', zh: 'TR4085Plus 高级蜡基碳带' },
      { hu: 'Nagy tartósságú resin szalagok', en: 'Highly durable resin ribbons', de: 'Hochbeständige Resin-Farbbänder', ko: '고내구성 Resin 리본', zh: '高耐久树脂基碳带' },
      { hu: 'Papír és szintetikus címkékhez', en: 'For paper and synthetic labels', de: 'Für Papier- und Kunststoffetiketten', ko: '종이 및 합성수지 라벨용', zh: '适用于纸质与合成标签' },
    ],
  },
  {
    ...
    short: {
      ...
      en: 'Thermal transfer ribbons for flat-head and near-edge printers.', de: 'Thermotransfer-Farbbänder für Flat-Head- und Near-Edge-Drucker.', ko: '플랫 헤드 및 니어 엣지 프린터용 열전사 리본.', zh: '适用于平压式与近端式打印机的热转印碳带。',
    },
    description: {
      ...
      en: 'ARMOR-IIMAK is a market leader in thermal transfer ribbons. Three ribbon families — wax (AWR 1), wax/resin (APR 1, APR 6, APR 600) and resin (AXR 1, AXR 7, AXR 100, AXR 600, AXR 800/900) — for flat-head and near-edge printers, for paper and synthetic labels as well as flexible packaging. High-speed printing (up to 1 m/s) with excellent print resistance.', de: 'ARMOR-IIMAK ist ein Marktführer bei Thermotransfer-Farbbändern. Drei Farbbandfamilien — Wax (AWR 1), Wax-Resin (APR 1, APR 6, APR 600) und Resin (AXR 1, AXR 7, AXR 100, AXR 600, AXR 800/900) — für Flat-Head- und Near-Edge-Drucker, für Papier- und Kunststoffetiketten sowie flexible Verpackungen. Hochgeschwindigkeitsdruck (bis 1 m/s) mit hervorragender Druckbeständigkeit.', ko: 'ARMOR-IIMAK은 열전사 리본 시장의 선도 기업입니다. Wax(AWR 1), Wax/Resin(APR 1, APR 6, APR 600), Resin(AXR 1, AXR 7, AXR 100, AXR 600, AXR 800/900)의 세 가지 리본 제품군을 플랫 헤드 및 니어 엣지 프린터용으로 제공하며, 종이·합성수지 라벨은 물론 연포장에도 사용할 수 있습니다. 뛰어난 인쇄 내구성과 함께 고속 인쇄(최대 1 m/s)를 지원합니다.', zh: 'ARMOR-IIMAK 是热转印碳带领域的市场领导者。三大碳带系列——蜡基（AWR 1）、混合基（APR 1、APR 6、APR 600）与树脂基（AXR 1、AXR 7、AXR 100、AXR 600、AXR 800/900）——适用于平压式与近端式打印机，可打印纸质与合成标签以及软包装。支持高速打印（最高 1 m/s），打印耐性出色。',
    },
    features: [
      { hu: 'Wax, wax/resin és resin családok', en: 'Wax, wax/resin and resin families', de: 'Wax-, Wax-Resin- und Resin-Familien', ko: 'Wax, Wax/Resin 및 Resin 제품군', zh: '蜡基、混合基与树脂基系列' },
      { hu: 'Flat-head és near-edge nyomtatókhoz', en: 'For flat-head and near-edge printers', de: 'Für Flat-Head- und Near-Edge-Drucker', ko: '플랫 헤드 및 니어 엣지 프린터용', zh: '适用于平压式与近端式打印机' },
      { hu: 'Nagy sebességű nyomtatás (akár 1 m/s)', en: 'High-speed printing (up to 1 m/s)', de: 'Hochgeschwindigkeitsdruck (bis 1 m/s)', ko: '고속 인쇄(최대 1 m/s)', zh: '高速打印（最高 1 m/s）' },
      { hu: 'Kiváló nyomatállóság', en: 'Excellent print resistance', de: 'Hervorragende Druckbeständigkeit', ko: '뛰어난 인쇄 내구성', zh: '出色的打印耐性' },
    ],
  },
  {
    slug: 'start-ld3000',
    ...
    short: {
      ...
      en: 'High-speed electric label dispenser for small labels and small work areas.', de: 'Elektrischer Hochgeschwindigkeits-Etikettenspender für kleine Etiketten und kleine Arbeitsbereiche.', ko: '소형 라벨 및 좁은 작업 공간을 위한 고속 전동 라벨 디스펜서.', zh: '面向小标签与小型工作区域的高速电动标签剥离机。',
    },
    description: {
      ...
      en: 'The LD3000 is a high-speed electric label dispenser for small labels and die-cut parts (paper, polyester, vinyl, acetate, foam, foil). A photosensor ensures accurate peeling, dispensing and advancing, and the liner is automatically rewound. Tool-free adjustment, durable anodized aluminum housing. 12V DC with an included 100–240V universal transformer. Made in the U.S.A.', de: 'Der LD3000 ist ein elektrischer Hochgeschwindigkeits-Etikettenspender für kleine Etiketten und Stanzteile (Papier, Polyester, Vinyl, Acetat, Schaumstoff, Folie). Ein Fotosensor sorgt für präzises Ablösen, Spenden und Vorschieben, das Trägermaterial wird automatisch aufgewickelt. Werkzeuglose Einstellung, langlebiges Gehäuse aus eloxiertem Aluminium. 12 V DC mit mitgeliefertem 100–240-V-Universalnetzteil. Hergestellt in den USA.', ko: 'LD3000은 소형 라벨과 다이컷 부품(종이, 폴리에스터, 비닐, 아세테이트, 폼, 포일)을 위한 고속 전동 라벨 디스펜서입니다. 포토센서가 정확한 박리, 디스펜싱, 이송을 보장하며 라이너는 자동으로 리와인딩됩니다. 공구 없이 조정 가능하고 내구성 있는 아노다이징 알루미늄 하우징을 갖추었습니다. 12V DC 구동에 100–240V 범용 트랜스포머가 포함됩니다. 미국산.', zh: 'LD3000 是一款高速电动标签剥离机，适用于小标签与模切件（纸张、聚酯、乙烯基、醋酸酯、泡棉、箔材）。光电传感器确保精确的剥离、送出与走带，底纸自动回卷。免工具调节，耐用的阳极氧化铝外壳。12V DC 供电，随附 100–240V 通用变压器。美国制造。',
    },
    features: [
      { hu: 'Címkeszélesség 6–57 mm, hossz 6–76 mm', en: 'Label width 6–57 mm, length 6–76 mm', de: 'Etikettenbreite 6–57 mm, Länge 6–76 mm', ko: '라벨 폭 6–57 mm, 길이 6–76 mm', zh: '标签宽度 6–57 mm，长度 6–76 mm' },
      { hu: 'Adagolási sebesség 56 mm/s', en: 'Feed speed 56 mm/s', de: 'Vorschubgeschwindigkeit 56 mm/s', ko: '이송 속도 56 mm/s', zh: '送标速度 56 mm/s' },
      { hu: 'Fotoszenzoros pontosság, automatikus hordozó-felcsévélés', en: 'Photosensor accuracy, automatic liner rewind', de: 'Fotosensor-Genauigkeit, automatische Trägermaterial-Aufwicklung', ko: '포토센서 정밀도, 자동 라이너 리와인딩', zh: '光电传感器精度，底纸自动回卷' },
      { hu: 'Max. tekercsátmérő 190 mm (1"/3" mag)', en: 'Max. roll diameter 190 mm (1"/3" core)', de: 'Max. Rollendurchmesser 190 mm (1"-/3"-Kern)', ko: '최대 롤 직경 190 mm(1"/3" 코어)', zh: '最大卷径 190 mm（1"/3" 卷芯）' },
      { hu: 'Anodizált alumínium ház', en: 'Anodized aluminum housing', de: 'Gehäuse aus eloxiertem Aluminium', ko: '아노다이징 알루미늄 하우징', zh: '阳极氧化铝外壳' },
    ],
  },
  {
    slug: 'start-ld3500',
    ...
    short: {
      ...
      en: 'Electric label dispenser for clear and challenging materials.', de: 'Elektrischer Etikettenspender für transparente und anspruchsvolle Materialien.', ko: '투명 및 까다로운 소재를 위한 전동 라벨 디스펜서.', zh: '适用于透明及高难度材料的电动标签剥离机。',
    },
    description: {
  ...
  },
  {
    ...
    short: {
      ...
      en: 'High-speed electric label dispenser for wider, 121 mm labels.', de: 'Elektrischer Hochgeschwindigkeits-Etikettenspender für breitere Etiketten bis 121 mm.', ko: '더 넓은 121 mm 라벨을 위한 고속 전동 라벨 디스펜서.', zh: '面向较宽（121 mm）标签的高速电动标签剥离机。',
    },
    description: {
      ...
      en: 'The LD6050 is a high-speed electric label dispenser for wider labels and die-cut parts up to 4.75" (121 mm) wide. Photosensor peeling and advancing, automatic liner rewind, tool-free adjustment and durable metal construction. Made in the U.S.A.', de: 'Der LD6050 ist ein elektrischer Hochgeschwindigkeits-Etikettenspender für breitere Etiketten und Stanzteile bis 4,75" (121 mm) Breite. Fotosensorgesteuertes Ablösen und Vorschieben, automatische Aufwicklung des Trägermaterials, werkzeuglose Einstellung und langlebige Metallkonstruktion. Hergestellt in den USA.', ko: 'LD6050은 최대 4.75"(121 mm) 폭의 넓은 라벨과 다이컷 부품을 위한 고속 전동 라벨 디스펜서입니다. 포토센서 방식의 박리와 이송, 자동 라이너 리와인딩, 공구 없는 조정, 내구성 있는 금속 구조를 갖추었습니다. 미국산.', zh: 'LD6050 是一款高速电动标签剥离机，适用于宽度最大 4.75"（121 mm）的较宽标签与模切件。光电传感器控制剥离与走带，底纸自动回卷，免工具调节，耐用的金属结构。美国制造。',
    },
    features: [
      { hu: 'Címkeszélesség akár 121 mm', en: 'Label width up to 121 mm', de: 'Etikettenbreite bis 121 mm', ko: '라벨 폭 최대 121 mm', zh: '标签宽度最大 121 mm' },
      { hu: 'Nagy sebességű adagolás', en: 'High-speed dispensing', de: 'Hochgeschwindigkeits-Spenden', ko: '고속 디스펜싱', zh: '高速剥离' },
      { hu: 'Fotoszenzoros pontosság', en: 'Photosensor accuracy', de: 'Fotosensor-Genauigkeit', ko: '포토센서 정밀도', zh: '光电传感器精度' },
      { hu: 'Automatikus hordozó-felcsévélés', en: 'Automatic liner rewind', de: 'Automatische Trägermaterial-Aufwicklung', ko: '자동 라이너 리와인딩', zh: '底纸自动回卷' },
      { hu: 'Tartós fémfelépítés', en: 'Durable metal construction', de: 'Langlebige Metallkonstruktion', ko: '내구성 있는 금속 구조', zh: '耐用金属结构' },
    ],
  },
  {
    slug: 'start-ld8100',
    ...
    short: {
      ...
      en: 'Super-speed electric label dispenser for long, wide packaging labels.', de: 'Superschneller elektrischer Etikettenspender für lange, breite Verpackungsetiketten.', ko: '길고 넓은 포장 라벨을 위한 초고속 전동 라벨 디스펜서.', zh: '面向长幅宽幅包装标签的超高速电动标签剥离机。',
    },
    description: {
  ...
  },
  {
    ...
    short: {
      ...
      en: 'High-speed label dispenser for long, wide labels (up to 203 mm).', de: 'Hochgeschwindigkeits-Etikettenspender für lange, breite Etiketten (bis 203 mm).', ko: '길고 넓은 라벨(최대 203 mm)을 위한 고속 라벨 디스펜서.', zh: '面向长幅宽幅标签（最大 203 mm）的高速标签剥离机。',
    },
    description: {
      ...
      en: 'The LDX8050 is a high-speed electric label dispenser for long, wide packaging labels up to 8" (203 mm) wide. High-torque motor for large-diameter rolls (max. 305 mm), adjustable strip plate, photosensor accuracy, automatic liner rewind. Feed speed 99 mm/s. Made in the U.S.A.', de: 'Der LDX8050 ist ein elektrischer Hochgeschwindigkeits-Etikettenspender für lange, breite Verpackungsetiketten bis 8" (203 mm) Breite. Drehmomentstarker Motor für große Rollen (max. 305 mm), verstellbare Spendekante, Fotosensor-Genauigkeit, automatische Aufwicklung des Trägermaterials. Vorschubgeschwindigkeit 99 mm/s. Hergestellt in den USA.', ko: 'LDX8050은 최대 8"(203 mm) 폭의 길고 넓은 포장 라벨을 위한 고속 전동 라벨 디스펜서입니다. 대직경 롤(최대 305 mm)용 고토크 모터, 조정 가능한 스트립 플레이트, 포토센서 정밀도, 자동 라이너 리와인딩을 갖추었습니다. 이송 속도 99 mm/s. 미국산.', zh: 'LDX8050 是一款高速电动标签剥离机，适用于宽度最大 8"（203 mm）的长幅宽幅包装标签。高扭矩电机适配大直径卷料（最大 305 mm），可调剥离板，光电传感器精度，底纸自动回卷。送标速度 99 mm/s。美国制造。',
    },
    features: [
      { hu: 'Címkeszélesség 6–203 mm, hossz 13–305 mm', en: 'Label width 6–203 mm, length 13–305 mm', de: 'Etikettenbreite 6–203 mm, Länge 13–305 mm', ko: '라벨 폭 6–203 mm, 길이 13–305 mm', zh: '标签宽度 6–203 mm，长度 13–305 mm' },
      { hu: 'Adagolási sebesség 99 mm/s', en: 'Feed speed 99 mm/s', de: 'Vorschubgeschwindigkeit 99 mm/s', ko: '이송 속도 99 mm/s', zh: '送标速度 99 mm/s' },
      { hu: 'Max. tekercsátmérő 305 mm', en: 'Max. roll diameter 305 mm', de: 'Max. Rollendurchmesser 305 mm', ko: '최대 롤 직경 305 mm', zh: '最大卷径 305 mm' },
      { hu: 'Nagy nyomatékú motor', en: 'High-torque motor', de: 'Drehmomentstarker Motor', ko: '고토크 모터', zh: '高扭矩电机' },
      { hu: 'Fotoszenzoros pontosság', en: 'Photosensor accuracy', de: 'Fotosensor-Genauigkeit', ko: '포토센서 정밀도', zh: '光电传感器精度' },
    ],
  },
  {
    ...
    short: {
      ...
      en: 'Super-speed label dispenser for long, wide labels at 198 mm/s.', de: 'Superschneller Etikettenspender für lange, breite Etiketten mit 198 mm/s.', ko: '198 mm/s 속도로 길고 넓은 라벨을 처리하는 초고속 라벨 디스펜서.', zh: '以 198 mm/s 处理长幅宽幅标签的超高速标签剥离机。',
    },
    description: {
  ...
  },
  {
    ...
    short: {
      ...
      en: 'Electric automatic heavy-duty tape dispenser for tape up to 80 mm wide.', de: 'Elektrischer automatischer Heavy-Duty-Klebebandspender für Bänder bis 80 mm Breite.', ko: '최대 80 mm 폭 테이프를 위한 전동 자동 헤비듀티 테이프 디스펜서.', zh: '适用于最宽 80 mm 胶带的重载型电动自动胶带切割机。',
    },
    description: {
  ...
  },
  {
    ...
    short: {
      ...
      en: 'Tape dispenser for high-adhesive, technical tapes (VHB, ACX, foam).', de: 'Klebebandspender für stark haftende, technische Bänder (VHB, ACX, Schaumstoff).', ko: '고점착·기능성 테이프(VHB, ACX, 폼)용 테이프 디스펜서.', zh: '适用于高粘性技术胶带（VHB、ACX、泡棉）的胶带切割机。',
    },
    description: {
      ...
      en: 'The TDA080-NS is a modified TDA080 with special flat advancement rollers for high-adhesive and technical tapes (e.g. VHB, ACX, foam, double-sided, PET, fleece). It automatically dispenses and cuts virtually any tape up to 3.15" (80 mm) wide. Digitally programmable length, ±1 mm cutting accuracy, four operating modes, solid metal construction. 3" (76 mm) core. Designed in the U.S.A.', de: 'Der TDA080-NS ist ein modifizierter TDA080 mit speziellen flachen Vorschubrollen für stark haftende und technische Klebebänder (z. B. VHB, ACX, Schaumstoff, doppelseitig, PET, Vlies). Er spendet und schneidet automatisch praktisch jedes Klebeband bis 3,15" (80 mm) Breite. Digital programmierbare Länge, ±1 mm Schnittgenauigkeit, vier Betriebsmodi, solide Metallkonstruktion. 3"-Kern (76 mm). Entwickelt in den USA.', ko: 'TDA080-NS는 고점착 및 기능성 테이프(예: VHB, ACX, 폼, 양면, PET, 플리스)를 위한 특수 평면 이송 롤러를 장착한 TDA080의 개조 버전입니다. 최대 3.15"(80 mm) 폭의 거의 모든 테이프를 자동으로 디스펜싱하고 커팅합니다. 디지털 방식의 길이 프로그래밍, ±1 mm 커팅 정밀도, 4가지 작동 모드, 견고한 금속 구조를 갖추었습니다. 3"(76 mm) 코어. 미국에서 설계되었습니다.', zh: 'TDA080-NS 是 TDA080 的改进版本，配备特殊的平面送带辊，适用于高粘性及技术类胶带（如 VHB、ACX、泡棉、双面胶、PET、无纺布）。可自动送出并切割几乎所有宽度最大 3.15"（80 mm）的胶带。长度可数字化编程，切割精度 ±1 mm，四种工作模式，坚固的金属结构。3"（76 mm）卷芯。美国设计。',
    },
    features: [
      { hu: 'Erős tapadású / technikai szalagokhoz', en: 'For high-adhesive / technical tapes', de: 'Für stark haftende / technische Klebebänder', ko: '고점착 / 기능성 테이프용', zh: '适用于高粘性 / 技术类胶带' },
      { hu: 'Speciális lapos adagológörgők', en: 'Special flat advancement rollers', de: 'Spezielle flache Vorschubrollen', ko: '특수 평면 이송 롤러', zh: '特殊平面送带辊' },
      { hu: 'Szalagszélesség 6–80 mm', en: 'Tape width 6–80 mm', de: 'Klebebandbreite 6–80 mm', ko: '테이프 폭 6–80 mm', zh: '胶带宽度 6–80 mm' },
      { hu: 'Vágáshossz 40–9999 mm, ±1 mm pontosság', en: 'Cut length 40–9999 mm, ±1 mm accuracy', de: 'Schnittlänge 40–9999 mm, ±1 mm Genauigkeit', ko: '커팅 길이 40–9999 mm, ±1 mm 정밀도', zh: '切割长度 40–9999 mm，精度 ±1 mm' },
      { hu: '4 üzemmód, tömör fémfelépítés', en: '4 operating modes, solid metal build', de: '4 Betriebsmodi, solide Metallkonstruktion', ko: '4가지 작동 모드, 견고한 금속 구조', zh: '4 种工作模式，坚固金属结构' },
    ],
  },
  {
    slug: 'start-tda150-m',
    ...
    short: {
      ...
      en: 'Heavy-duty tape dispenser for tape up to 150 mm wide, with 5-length memory.', de: 'Heavy-Duty-Klebebandspender für Bänder bis 150 mm Breite, mit Speicher für 5 Längen.', ko: '5개 길이 메모리를 갖춘, 최대 150 mm 폭 테이프용 헤비듀티 테이프 디스펜서.', zh: '适用于最宽 150 mm 胶带的重载型胶带切割机，具备 5 组长度记忆。',
    },
    description: {
