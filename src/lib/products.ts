    ...
    applicators: [
      {
        ...
        description: {
          ...
          en: 'For larger labels — labeling the front, side or back of the product.', it: 'Per etichette di formato maggiore — etichettatura del fronte, del lato o del retro del prodotto.', es: 'Para etiquetas de mayor tamaño — etiquetado de la parte frontal, lateral o trasera del producto.', de: 'Für größere Etiketten — Etikettierung vorn, seitlich oder hinten am Produkt.', ko: '대형 라벨용 — 제품의 전면, 측면 또는 후면 라벨링.', zh: '适用于较大标签——在产品正面、侧面或背面贴标。',
        },
        longDescription: {
          ...
          en: 'Applies labels in real time from the top or side onto packages in motion — preferably to the front or back of a package. The pad picks up the label while it is printed, and the pivot arm transfers it to the product at 0–90°.', it: 'Applica le etichette in tempo reale dall’alto o lateralmente su confezioni in movimento — preferibilmente sul fronte o sul retro della confezione. Il tampone applicatore preleva l’etichetta mentre viene stampata e il braccio oscillante la trasferisce sul prodotto a 0–90°.', es: 'Aplica etiquetas en tiempo real desde arriba o desde el lateral sobre paquetes en movimiento, preferentemente en la parte frontal o trasera del paquete. El pad aplicador recoge la etiqueta mientras se imprime y el brazo pivotante la transfiere al producto a 0–90°.', de: 'Bringt Etiketten in Echtzeit von oben oder von der Seite auf bewegte Verpackungen auf — bevorzugt auf die Vorder- oder Rückseite eines Pakets. Der Stempel übernimmt das Etikett während des Drucks, und der Schwenkarm überträgt es im Winkel von 0–90° auf das Produkt.', ko: '이동 중인 패키지의 상단 또는 측면에서 실시간으로 라벨을 부착하며, 주로 패키지의 전면이나 후면에 부착합니다. 패드가 인쇄되는 라벨을 픽업하고, 피벗 암이 0–90° 범위에서 라벨을 제품에 전달합니다.', zh: '从顶部或侧面向运动中的包装实时贴标——优先贴于包装的正面或背面。吸盘在标签打印的同时将其吸取，摆臂以 0–90° 将标签转贴到产品上。',
        },
        params: [
      ...
      },
      {
        ...
        name: { hu: '4014 Stroke applikátor', en: '4014 Stroke applicator', it: 'Applicatore a corsa 4014', es: 'Aplicador de carrera 4014', de: '4014 Hub-Applikator', ko: '4014 스트로크 어플리케이터', zh: '4014 行程式贴标模块' },
        description: {
          hu: 'Egyszerű címkézéshez.',
          en: 'For simple labeling.', it: 'Per un’etichettatura semplice.', es: 'Para un etiquetado sencillo.', de: 'Für einfache Etikettierung.', ko: '간단한 라벨링용.', zh: '适用于简单贴标任务。',
        },
        longDescription: {
          ...
          en: 'Applies labels in real time from all sides onto packages. The type of pad defines whether a package has to be at rest or can be in motion. The stroke cylinder length defines the maximum distance between the package and the peel-off plate.', it: 'Applica le etichette in tempo reale da tutti i lati sulle confezioni. Il tipo di tampone applicatore determina se la confezione deve essere ferma o può essere in movimento. La lunghezza del cilindro di corsa definisce la distanza massima tra la confezione e la piastra di spellicolatura.', es: 'Aplica etiquetas en tiempo real desde todos los lados sobre paquetes. El tipo de pad aplicador define si el paquete debe estar parado o puede estar en movimiento. La longitud del cilindro de carrera define la distancia máxima entre el paquete y la placa de despegado.', de: 'Bringt Etiketten in Echtzeit von allen Seiten auf Verpackungen auf. Der Stempeltyp bestimmt, ob ein Paket im Stillstand sein muss oder in Bewegung sein darf. Die Länge des Hubzylinders bestimmt den maximalen Abstand zwischen Paket und Spendekante.', ko: '패키지의 모든 면에 실시간으로 라벨을 부착합니다. 패드 유형에 따라 패키지가 정지 상태여야 하는지 이동 중이어도 되는지가 결정됩니다. 스트로크 실린더 길이는 패키지와 필오프 플레이트 사이의 최대 거리를 결정합니다.', zh: '可从各个方向向包装实时贴标。吸盘类型决定包装必须静止还是可以处于运动状态。行程气缸长度决定包装与剥离板之间的最大距离。',
        },
        params: [
      ...
      },
      {
        ...
        name: { hu: '4114 Stroke applikátor', en: '4114 Stroke applicator', it: 'Applicatore a corsa 4114', es: 'Aplicador de carrera 4114', de: '4114 Hub-Applikator', ko: '4114 스트로크 어플리케이터', zh: '4114 行程式贴标模块' },
        description: {
          hu: 'Nagy pontosságú címkézés kis címkékhez (min. 4x4mm).',
          en: 'High-precision labeling for small labels (min. 4x4 mm).', it: 'Etichettatura ad alta precisione per etichette piccole (min. 4x4 mm).', es: 'Etiquetado de alta precisión para etiquetas pequeñas (mín. 4x4 mm).', de: 'Hochpräzise Etikettierung für kleine Etiketten (min. 4x4 mm).', ko: '소형 라벨(최소 4x4 mm)을 위한 고정밀 라벨링.', zh: '针对小标签（最小 4x4 mm）的高精度贴标。',
        },
        longDescription: {
          ...
          en: 'Applies very small and midsized labels in real time from all sides. The pad picks up the label while it is printed and a short stroke cylinder brings it into position horizontally. With a form pad it labels cylindrical and curved surfaces too.', it: 'Applica in tempo reale etichette molto piccole e di medio formato da tutti i lati. Il tampone applicatore preleva l’etichetta mentre viene stampata e un cilindro a corsa breve la porta in posizione orizzontalmente. Con un tampone sagomato etichetta anche superfici cilindriche e curve.', es: 'Aplica etiquetas muy pequeñas y medianas en tiempo real desde todos los lados. El pad aplicador recoge la etiqueta mientras se imprime y un cilindro de carrera corta la lleva a su posición horizontalmente. Con un pad conformado etiqueta también superficies cilíndricas y curvas.', de: 'Bringt sehr kleine und mittelgroße Etiketten in Echtzeit von allen Seiten auf. Der Stempel übernimmt das Etikett während des Drucks, ein kurzer Hubzylinder bringt es horizontal in Position. Mit einem Formstempel etikettiert er auch zylindrische und gewölbte Oberflächen.', ko: '초소형 및 중형 라벨을 모든 면에서 실시간으로 부착합니다. 패드가 인쇄되는 라벨을 픽업하고 쇼트 스트로크 실린더가 이를 수평 위치로 이동시킵니다. 폼 패드를 사용하면 원통형 표면과 곡면에도 라벨을 부착할 수 있습니다.', zh: '可从各个方向实时贴附极小及中等尺寸的标签。吸盘在标签打印的同时将其吸取，短行程气缸将其水平送至贴标位置。配合成型吸盘还可为圆柱面与曲面贴标。',
        },
        params: [
      ...
      },
      {
        ...
        name: { hu: '5314 Vákuumszalagos applikátor', en: '5314 Vacuum-belt applicator', it: 'Applicatore a nastro aspirante 5314', es: 'Aplicador de cinta de vacío 5314', de: '5314 Vakuumband-Applikator', ko: '5314 진공 벨트 어플리케이터', zh: '5314 真空带式贴标模块' },
        description: {
          hu: 'Címkézés nagy sebességgel, mozgásban lévő termékeknél.',
          en: 'High-speed labeling of products in motion.', it: 'Etichettatura ad alta velocità di prodotti in movimento.', es: 'Etiquetado a alta velocidad de productos en movimiento.', de: 'Hochgeschwindigkeits-Etikettierung bewegter Produkte.', ko: '이동 중인 제품의 고속 라벨링.', zh: '对运动中的产品进行高速贴标。',
        },
        longDescription: {
          ...
          en: 'Applies labels in real time from all sides onto plane surfaces of packages in motion. A vacuum belt conveys the printed label to the point of transfer, and application is triggered by an external signal.', it: 'Applica le etichette in tempo reale da tutti i lati su superfici piane di confezioni in movimento. Un nastro aspirante trasporta l’etichetta stampata fino al punto di trasferimento e l’applicazione è attivata da un segnale esterno.', es: 'Aplica etiquetas en tiempo real desde todos los lados sobre superficies planas de paquetes en movimiento. Una cinta de vacío transporta la etiqueta impresa hasta el punto de transferencia y la aplicación se activa mediante una señal externa.', de: 'Bringt Etiketten in Echtzeit von allen Seiten auf ebene Oberflächen bewegter Verpackungen auf. Ein Vakuumband befördert das gedruckte Etikett zum Übergabepunkt; die Etikettierung wird durch ein externes Signal ausgelöst.', ko: '이동 중인 패키지의 평면에 모든 면에서 실시간으로 라벨을 부착합니다. 진공 벨트가 인쇄된 라벨을 전달 지점까지 이송하며, 부착은 외부 신호로 트리거됩니다.', zh: '可从各个方向向运动中包装的平面实时贴标。真空传送带将打印好的标签输送至转贴点，贴标由外部信号触发。',
        },
        params: [
          { label: { hu: 'Címkeszélesség', en: 'Label width', it: 'Larghezza etichetta', es: 'Ancho de etiqueta', de: 'Etikettenbreite', ko: '라벨 폭', zh: '标签宽度' }, value: { hu: '20–174 mm', en: '20–174 mm', it: '20–174 mm', es: '20–174 mm', de: '20–174 mm', ko: '20–174 mm', zh: '20–174 mm' } },
          { label: { hu: 'Címkemagasság', en: 'Label height', it: 'Altezza etichetta', es: 'Altura de etiqueta', de: 'Etikettenhöhe', ko: '라벨 높이', zh: '标签高度' }, value: { hu: '60–456 mm', en: '60–456 mm', it: '60–456 mm', es: '60–456 mm', de: '60–456 mm', ko: '60–456 mm', zh: '60–456 mm' } },
          ...
          { label: { hu: 'Csomagsebesség', en: 'Package speed', it: 'Velocità della confezione', es: 'Velocidad del paquete', de: 'Paketgeschwindigkeit', ko: '패키지 속도', zh: '包装速度' }, value: { hu: 'max. 0,5 m/s', en: 'up to 0.5 m/s', it: 'fino a 0,5 m/s', es: 'hasta 0,5 m/s', de: 'bis 0,5 m/s', ko: '최대 0.5 m/s', zh: '最高 0.5 m/s' } },
          ...
          { label: { hu: 'Teljesítményfelvétel', en: 'Power consumption', it: 'Assorbimento', es: 'Consumo eléctrico', de: 'Leistungsaufnahme', ko: '소비 전력', zh: '功耗' }, value: { hu: 'max. 90 W', en: 'max. 90 W', it: 'max. 90 W', es: 'máx. 90 W', de: 'max. 90 W', ko: '최대 90 W', zh: '最大 90 W' } },
          { label: { hu: 'Tömeg', en: 'Weight', it: 'Peso', es: 'Peso', de: 'Gewicht', ko: '중량', zh: '重量' }, value: { hu: '7–8 kg', en: '7–8 kg', it: '7–8 kg', es: '7–8 kg', de: '7–8 kg', ko: '7–8 kg', zh: '7–8 kg' } },
        ],
      },
      {
        slug: 'hq-4514',
