  ...
  },
  {
    ...
    variants: [
      ...
      },
      {
        name: 'InNo-Liner',
        purpose: {
          hu: 'Vízzel aktiválódó ragasztó, szilikon egyáltalán nincs benne. Nedvszívó karton- és papírfelületre való — jellemzően logisztikai szállítási címkékhez.',
          en: 'A water-activated adhesive with no silicone at all. Meant for absorbent cardboard and paper surfaces — typically shipping labels in logistics.', it: 'Adesivo attivato con acqua, senza alcun silicone. Destinato a superfici assorbenti di cartone e carta — tipicamente etichette di spedizione nella logistica.', es: 'Adhesivo activado con agua, sin silicona alguna. Pensado para superficies absorbentes de cartón y papel: normalmente etiquetas de envío en logística.', de: 'Ein mit Wasser aktivierter Klebstoff, ganz ohne Silikon. Für saugfähige Karton- und Papieroberflächen — typischerweise Versandetiketten in der Logistik.', ko: '물로 활성화되는 접착제로, 실리콘이 전혀 들어 있지 않습니다. 흡수성 판지와 종이 표면용이며 주로 물류의 배송 라벨에 사용합니다.', zh: '由水激活的胶粘剂，完全不含硅油。适用于吸水的纸板与纸质表面——通常是物流中的运单标签。',
        },
        params: [
