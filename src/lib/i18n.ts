export const locales = ['hu', 'en', 'us', 'de', 'it', 'es', 'ko', 'zh'] as const;
...
/**
 * BCP-47 nyelvi címke a `hreflang` és a `<html lang>` attribútumhoz.
 *
 * Az útvonal rövidsége miatt a brit és az amerikai változat mappaneve `en` és
 * `us`, ez viszont NEM adható át a keresőnek: az „us" nem nyelvkód (a
 * hreflang="us" érvénytelen, a Google figyelmen kívül hagyja), a puszta „en"
 * pedig nem mondaná meg, melyik a brit és melyik az amerikai. A két angol
 * változat így kap régiós címkét — ez különbözteti meg őket egymástól a
 * találati listában, és ez irányítja a látogatót a saját piacának megfelelő
 * oldalra (később a bluewaytrade.us-ra).
 */
...
export const dictionaries = {
  hu: {
    ...
    industries: {
      title: 'Iparágak',
      lead: 'Ugyanaz a kínálat a feladat felől nézve: melyik iparágban mit kell jelölni vagy címkézni, és melyik gép való rá.',
      machineCount: (n: number) => `${n} ajánlott gép`,
      regulationsTitle: 'Vonatkozó előírások',
      regulationsLead: 'A jelölés tartalmát és formáját sok helyen jogszabály szabja meg — ezeket érdemes a tervezés elején tisztázni.',
      productsTitle: 'Ajánlott gépek',
      productsLead: 'Nem teljes lista, hanem az, ami ebben az iparágban a leggyakoribb feladatokra való.',
      guidesTitle: 'Kapcsolódó útmutatók',
      forProductTitle: 'Ehhez az iparághoz is ajánljuk',
      ctaTitle: 'Nem találja a saját feladatát?',
      ctaText: 'Írja le, mit kell jelölni, mekkora darabszámban és milyen körülmények között — és javaslatot adunk rá.',
      ctaButton: 'Kapcsolatfelvétel',
    },
    about: {
      title: 'Rólunk',
    ...
    servicePage: {
      ...
      form: {
        ...
        attachHint: 'Egy fénykép a hibáról vagy a hibaüzenetről sokat segít. Több fájl is kiválasztható, összesen legfeljebb 7 MB.',
  ...
  en: {
    ...
    contact: {
      ...
      hours: 'Monday–Friday 8:00–15:00',
      phoneLabel: 'Phone',
      phone: '+36 30 279 6679',
      emailLabel: 'Email',
      email: 'info@blueway.hu',
    ...
    industries: {
      title: 'Industries',
      lead: 'The same range seen from the task: what needs marking or labelling in each industry, and which machine is right for it.',
      machineCount: (n: number) => `${n} recommended machines`,
      regulationsTitle: 'Applicable regulations',
      regulationsLead: 'In many cases the content and form of the marking is set by law — worth clarifying at the start of the project.',
      productsTitle: 'Recommended machines',
      productsLead: 'Not a complete list, but what suits the most common tasks in this industry.',
      guidesTitle: 'Related guides',
      forProductTitle: 'Also recommended for these industries',
      ctaTitle: 'Not finding your own task?',
      ctaText: 'Tell us what needs marking, in what volume and under what conditions — and we will suggest a solution.',
      ctaButton: 'Contact us',
    },
    about: {
      title: 'About us',
    ...
    servicePage: {
      ...
      form: {
        ...
        attachHint: 'A photo of the fault or the error message helps a great deal. You can select multiple files, up to 7 MB in total.',
  ...
  us: {
    ...
    hero: {
      eyebrow: 'Blueway Trade Kft.',
      title: 'Custom product marking solutions',
      lead: 'Label printing, laser marking, spare parts and service — from the simplest task to complex enterprise systems.',
      ctaPrimary: 'Request a quote',
      ctaSecondary: 'Our products',
    },
    ...
    products: {
      ...
      inquiry: {
        title: 'Request a quote for this product',
        lead: 'Get in touch right away — fill out the form and we will reply shortly.',
        name: 'Name',
        namePlaceholder: 'Your name',
        company: 'Company',
        companyPlaceholder: 'Company name',
        ...
        attachHint: 'You can select multiple files, up to 7 MB in total.',
        attachTooLarge: 'The attached files may not exceed 7 MB in total.',
        attachBody: 'Files to attach (please add them to the opened email)',
        attachMailto: 'We’ve opened your email app with the message ready — please attach the selected files before sending.',
        requiredNote: 'Fields marked with an asterisk are required.',
        submit: 'Send quote request — no obligation',
        sending: 'Sending…',
    ...
    labelQuote: {
      ...
      emailHeading: 'Quote request received for label supplies',
      diagramLink: 'Label dimensions diagram',
      lead: 'Request a quote for a custom label. Provide your contact information and the basic label data — we will clarify any further parameters during the quotation.',
      contactTitle: 'Contact',
      specTitle: 'Label specification',
      optionalTitle: 'Further parameters (optional)',
      name: 'Name',
      ...
      ribbonResin: 'Resin',
      notes: 'Notes',
      notesPlaceholder: 'Further details: liner material, thickness, gap/pitch, color, sample or drawing available, etc.',
      attach: 'Attach a file (logo, label artwork, sample — image, PDF or other)',
      attachHint: 'You can select multiple files, up to 7 MB in total.',
      attachTooLarge: 'The attached files may not exceed 7 MB in total.',
      attachBody: 'Files to attach (please add them to the opened email)',
    ...
    industries: {
      title: 'Industries',
      lead: 'The same range seen from the task: what needs marking or labeling in each industry, and which machine is right for it.',
      machineCount: (n: number) => `${n} recommended machines`,
      regulationsTitle: 'Applicable regulations',
      regulationsLead: 'In many cases the content and form of the marking is set by law — worth clarifying at the start of the project.',
      productsTitle: 'Recommended machines',
    ...
    about: {
      title: 'About us',
      lead: 'Custom product marking solutions since 2014 — backed by twenty years of hands-on experience.',
      intro: [
        'Our specialists bring 20 years of experience to the table. Every one of us worked in the same or a closely related field before joining, so we meet your requirements with confident expertise.',
        'Blueway Trade Kft. offers custom product marking solutions, from the simplest labeling task all the way to complex enterprise systems. Our core activities are label printing, laser marking, spare part supply and service.',
        'We have been in business since 2014 and our site is in Nagytarcsa, Hungary. Our main activity is the wholesale of other machinery and equipment, with a strong focus on product marking and identification technologies.',
      ],
      facts: [
        { value: '2014', label: 'Founded' },
      ...
      offer: [
        ...
        { title: 'Laser marking systems', body: 'Industrial laser marking equipment and laser label printing solutions.' },
        { title: 'Labels and thermal transfer ribbons', body: 'Paper, thermal paper and plastic (PE, PP) substrates with a choice of adhesives: standard, high tack, removable and deep freeze.' },
        { title: 'Software solutions', body: 'NiceLabel from Designer level up to centralized Enterprise systems, plus other labeling software.' },
        { title: 'End-to-end service', body: 'Spare part supply, service, fast — often next day — delivery from our own stock and continuous technical support.' },
      ],
      whyTitle: 'Why work with us',
      why: [
      ...
      certificateBody: 'We have held the Dun & Bradstreet (formerly Bisnode) AAA Gold certificate for several years — it is awarded to companies with the strongest financial standing.',
      ctaTitle: 'Tell us about your task',
      ctaBody: 'Tell us what needs to be marked or labeled and we will help you choose the right solution.',
      ctaButton: 'Get in touch',
    },
    faq: {
      title: 'Frequently asked questions',
      ...
      items: [
        ...
        {
          q: 'Do you produce custom labels?',
          a: 'Yes, we produce pressure-sensitive labels in custom sizes, materials and constructions. On the label quote form a diagram helps with the dimensions.',
          href: '/termekek/cimkek-es-festekszalagok',
        },
        {
          q: 'Can I get samples of labels or ribbons?',
        ...
        {
          q: 'What does a linerless label mean?',
          a: 'It means there is no siliconized backing: the adhesive sits on the web itself and the printer cuts each label to length. So no liner waste is produced, far more labels fit on a roll, and label length can differ from job to job. In exchange it only takes direct thermal printing, and it needs a machine built for it: the CAB SQUIX Linerless for desktop work, the CAB HERMES QL for a production line.',
          href: '/tudastar/cimkeanyagok',
        },
        {
        ...
        {
          q: 'What should we watch for when choosing an RFID label?',
          a: 'Above all the surface it goes onto, and the size of the label. Metal needs a dedicated “on-metal” label and the OM antenna mounted on the print head; ordinary labels take the RS antenna, and very small tags or those with unusual radiation characteristics take HS. Label and antenna have to be chosen together — fitting one to the other afterward is expensive.',
          href: '/tudastar/rfid-cimkek',
        },
        {
          q: 'Which materials can be laser marked?',
          a: 'Fiber lasers can deep-engrave and anneal-mark metals (steel, stainless, aluminum, copper), and typically produce color-change marks on plastics. On request we produce a sample marking on your own part.',
          href: '/tudastar/lezeres-jeloles',
        },
        {
          q: 'Do we need protective eyewear and a separate area for a laser?',
          a: 'Enclosed Class 1 machines (such as the cab XENO 1 or the TYKMA Minilase) can be run on an open shop floor without protective eyewear. Open Class 4 systems, however, require a laser safety officer, eye protection and a restricted area.',
          href: '/tudastar/lezeres-jeloles',
        },
        {
          q: 'Is fume extraction needed for laser marking?',
        ...
        {
          q: 'What is the difference between the HEPA and the carbon filter?',
          a: 'The HEPA captures solid particles — dust, fume, ultrafine particles. Activated carbon binds gases and odors, such as solvent vapor. One does not replace the other, which is why both are fitted in series in these machines.',
          href: '/termekek/fust-es-porelszivok',
        },
        {
          q: 'We laser-mark PVC — is a general-purpose extractor enough?',
        ...
        {
          q: 'Does the extractor start automatically with the machine?',
          a: 'Yes. With an interfacing kit the extractor starts when the connected machine starts, and the other way around: the extractor can signal the machine when it goes into alarm. That way nobody can forget to turn it on.',
          href: '/termekek/fust-es-porelszivok',
        },
      ],
    },
    parts: {
      ...
      handoffTitle: 'Ask for help',
      handoffIntro:
        'We will send our team this conversation and your contact information, and they will identify the right part.',
      formName: 'Name',
      ...
      transcript: 'The conversation to be sent',
      consent:
        'I agree that Blueway Trade Kft. receives and processes the conversation above and my contact information for the purpose of preparing a quotation.',
      privacyLink: 'Privacy policy',
      consentRequired: 'Your consent is required before sending.',
      sendRequest: 'Send',
      sending: 'Sending…',
      cancel: 'Cancel',
      sent: 'Thank you, we have received it. We will get back to you shortly.',
      sentMailto: 'Your email client is open — just press Send.',
      error: 'Sending failed. Please try again, or write to info@blueway.hu.',
      subjectQuote: 'Spare part quotation request',
      subjectHelp: 'Spare part search — help requested',
      partNumber: 'Part number',
    ...
    servicePage: {
      title: 'Service',
      lead: 'We provide full service for the labeling and marking machines we supply. Choose whichever route solves your problem fastest.',
      onsiteTitle: 'On-site repair with a service call',
      onsiteBody: 'We come to you and repair the machine on site. This is the fastest route when the machine is built into a production line or cannot be moved.',
      sendInTitle: 'Send the machine to our service center',
      sendInBody: 'You can also send the machine to us for repair. Please enclose a short description of the problem and your contact information so we can get back to you.',
      sendInNote: 'Please contact us before sending the machine in.',
      addressLabel: 'Service address',
      phoneTitle: 'Help by phone',
      phoneBody: 'We are glad to help by phone with any machine we supply. Give us a call — many problems are solved in a few minutes.',
      phonePrimaryLabel: 'Primary',
      phoneSecondaryLabel: 'Alternate number',
      emailTitle: 'Or write to us',
      emailBody: 'If you would rather write, you can reach us at this address.',
      formTitle: 'Service request',
      formLead: 'Fill out the form and we will get back to you shortly. The more precisely you describe the problem, the faster we can help.',
      form: {
        contactTitle: 'Contact',
        name: 'Name',
        namePlaceholder: 'Your name',
        ...
        phone: 'Phone',
        phonePlaceholder: '+36 …',
        machineTitle: 'The machine and the problem',
        machine: 'Machine type',
        machinePlaceholder: 'e.g., CAB SQUIX 4',
        serial: 'Serial number (optional)',
        serialPlaceholder: 'on the nameplate at the back of the machine',
        fault: 'Description of the problem',
        faultPlaceholder: 'What do you see? When does it happen? What does the display say?',
        modeLabel: 'How should we repair it?',
        modeOnsite: 'I would like an on-site repair',
        modeSendIn: 'I will send the machine in',
        modePhone: 'I would like help by phone first',
        attach: 'Photo or document (optional)',
        attachHint: 'A photo of the problem or the error message helps a great deal. You can select multiple files, up to 7 MB in total.',
        attachTooLarge: 'Attachments may total at most 7 MB.',
        submit: 'Send service request',
        sending: 'Sending…',
        sent: 'Thank you, we have received it. We will be in touch shortly.',
        success: 'Your email client is open — just press Send.',
        error: 'Sending failed. Please try again, or give us a call.',
        subject: 'Service request',
      },
    },
  ...
  de: {
    ...
    contact: {
      ...
      hours: 'Montag–Freitag 8:00–15:00 Uhr',
      phoneLabel: 'Telefon',
      phone: '+36 30 279 6679',
      emailLabel: 'E-Mail',
      email: 'info@blueway.hu',
    ...
    industries: {
      title: 'Branchen',
      lead: 'Dasselbe Programm aus Sicht der Aufgabe: was in welcher Branche zu kennzeichnen oder zu etikettieren ist und welches Gerät dazu passt.',
      machineCount: (n: number) => `${n} empfohlene Geräte`,
      regulationsTitle: 'Geltende Vorschriften',
      regulationsLead: 'Inhalt und Form der Kennzeichnung sind vielfach gesetzlich vorgegeben — das sollte am Projektbeginn geklärt sein.',
      productsTitle: 'Empfohlene Geräte',
      productsLead: 'Keine vollständige Liste, sondern das, was zu den häufigsten Aufgaben dieser Branche passt.',
      guidesTitle: 'Passende Leitfäden',
      forProductTitle: 'Auch für diese Branchen empfohlen',
      ctaTitle: 'Ihre Aufgabe ist nicht dabei?',
      ctaText: 'Beschreiben Sie, was zu kennzeichnen ist, in welcher Stückzahl und unter welchen Bedingungen — wir schlagen eine Lösung vor.',
      ctaButton: 'Kontakt aufnehmen',
    },
    about: {
      title: 'Über uns',
    ...
    servicePage: {
      ...
      form: {
        ...
        attachHint: 'Ein Foto des Fehlers oder der Fehlermeldung hilft sehr. Mehrere Dateien möglich, insgesamt max. 7 MB.',
  ...
  it: {
    ...
    products: {
      ...
      productCount: (n: number) => `${n} prodotti`,
    ...
    contact: {
      ...
      hours: 'Lunedì–venerdì 8:00–15:00',
      phoneLabel: 'Telefono',
      phone: '+36 30 279 6679',
      emailLabel: 'Email',
      email: 'info@blueway.hu',
    ...
    industries: {
      title: 'Settori',
      lead: 'La stessa gamma vista dal lato del compito: che cosa marcare o etichettare in ciascun settore e quale macchina serve.',
      machineCount: (n: number) => `${n} macchine consigliate`,
      regulationsTitle: 'Normative applicabili',
      regulationsLead: 'In molti casi contenuto e forma della marcatura sono fissati per legge — meglio chiarirlo all\u2019inizio del progetto.',
      productsTitle: 'Macchine consigliate',
      productsLead: 'Non un elenco completo, ma ciò che risponde ai compiti più frequenti del settore.',
      guidesTitle: 'Guide correlate',
      forProductTitle: 'Consigliato anche per questi settori',
      ctaTitle: 'Non trova il suo caso?',
      ctaText: 'Ci descriva che cosa marcare, in quale quantità e in quali condizioni: le proporremo una soluzione.',
    ...
    servicePage: {
      ...
      form: {
        ...
        attachHint: 'Una foto del guasto o del messaggio di errore aiuta molto. Può selezionare più file, per un massimo complessivo di 7 MB.',
    ...
    footer: {
      ...
      privacyPolicy: 'Informativa sulla privacy (EN)',
      privacyPolicyHref: '/privacy-policy.html',
  ...
  es: {
    ...
    products: {
      ...
      productCount: (n: number) => `${n} productos`,
    ...
    industries: {
      title: 'Sectores',
      lead: 'La misma gama vista desde la tarea: qué hay que marcar o etiquetar en cada sector y qué máquina conviene.',
      machineCount: (n: number) => `${n} máquinas recomendadas`,
      regulationsTitle: 'Normativa aplicable',
      regulationsLead: 'En muchos casos la ley fija el contenido y la forma del marcado — conviene aclararlo al inicio del proyecto.',
      productsTitle: 'Máquinas recomendadas',
      productsLead: 'No es una lista completa, sino lo que resuelve las tareas más frecuentes del sector.',
      guidesTitle: 'Guías relacionadas',
      forProductTitle: 'También recomendado para estos sectores',
      ctaTitle: '¿No encuentra su caso?',
      ctaText: 'Cuéntenos qué hay que marcar, en qué volumen y en qué condiciones, y le propondremos una solución.',
      ctaButton: 'Contactar',
    },
    about: {
      title: 'Quiénes somos',
    ...
    servicePage: {
      ...
      form: {
        ...
        attachHint: 'Una foto de la avería o del mensaje de error ayuda mucho. Puede seleccionar varios archivos, hasta 7 MB en total.',
    ...
    footer: {
      ...
      privacyPolicy: 'Política de privacidad (EN)',
      privacyPolicyHref: '/privacy-policy.html',
  ...
  ko: {
    ...
    industries: {
      title: '산업 분야',
      lead: '같은 제품군을 작업 관점에서 봅니다. 각 산업에서 무엇을 마킹하거나 라벨링해야 하는지, 그리고 어떤 장비가 적합한지.',
      machineCount: (n: number) => `추천 장비 ${n}대`,
      regulationsTitle: '관련 규정',
      regulationsLead: '마킹의 내용과 형식은 법으로 정해진 경우가 많습니다. 프로젝트 초기에 확인하는 것이 좋습니다.',
      productsTitle: '추천 장비',
      productsLead: '전체 목록이 아니라, 이 산업에서 가장 흔한 작업에 맞는 장비입니다.',
      guidesTitle: '관련 가이드',
      forProductTitle: '이런 산업 분야에도 추천합니다',
      ctaTitle: '해당하는 작업이 없나요?',
      ctaText: '무엇을 어떤 수량으로, 어떤 환경에서 마킹해야 하는지 알려주시면 적합한 방안을 제안해 드립니다.',
      ctaButton: '문의하기',
    },
    about: {
      title: '회사 소개',
    ...
    servicePage: {
      ...
      form: {
        ...
        attach: '사진 또는 문서 (선택)',
        attachHint: '고장 부위나 오류 메시지 사진이 큰 도움이 됩니다. 여러 파일 선택 가능, 총 7 MB 이하.',
  ...
  zh: {
    ...
    industries: {
      title: '应用行业',
      lead: '从任务角度看同一套产品：各行业需要标记或贴标的是什么，以及哪台设备适合。',
      machineCount: (n: number) => `${n} 台推荐设备`,
      regulationsTitle: '适用法规',
      regulationsLead: '标识的内容与形式在许多情况下由法规规定，宜在项目初期明确。',
      productsTitle: '推荐设备',
      productsLead: '并非完整清单，而是针对该行业最常见任务的设备。',
      guidesTitle: '相关指南',
      forProductTitle: '也适用于这些行业',
      ctaTitle: '没有找到您的应用？',
      ctaText: '告诉我们需要标记什么、数量多少、在什么环境下使用，我们会给出建议。',
      ctaButton: '联系我们',
    },
    about: {
      title: '关于我们',
    ...
    servicePage: {
      ...
      form: {
        ...
        modePhone: '希望先获得电话支持',
        attach: '照片或文件（选填）',
        attachHint: '一张故障或错误提示的照片会很有帮助。可选择多个文件，总大小不超过 7 MB。',
