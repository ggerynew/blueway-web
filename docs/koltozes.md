...
| Az automata feltöltés **530 Login authentication failed**, pedig a TotalCommander belép | a fiók **országlistája** zárja ki a futtatót: Ügyfélközpont → FTP fül → *Engedélyezett országok*. Alapból csak Csehország és Magyarország van benne, a GitHub futtatói viszont sosem onnan jönnek. A workflow kiírja a futtató országát — azt kell felvenni. **A válaszidőből nem lehet dönteni**: a szolgáltató a címellenőrzést is az azonosítási lépésben végzi, tehát a letiltott országból érkező helyes jelszó ugyanolyan késleltetett 530-at kap, mint egy rossz jelszó |
